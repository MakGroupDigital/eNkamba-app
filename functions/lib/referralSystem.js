...
exports.getReferralStats = exports.applyReferralCode = exports.generateReferralLink = void 0;
...
exports.generateReferralLink = functions.https.onCall(async (data, context) => {
    ...
    if (context.auth.uid !== userId) {
        throw new functions.https.HttpsError('permission-denied', 'Vous ne pouvez générer que votre propre lien');
    }
    try {
        ...
        throw new functions.https.HttpsError('internal', 'Erreur lors de la génération du lien');
    }
});
/**
...
exports.applyReferralCode = functions.https.onCall(async (data, context) => {
    ...
    if (context.auth.uid !== userId) {
        throw new functions.https.HttpsError('permission-denied', 'Vous ne pouvez appliquer que pour votre propre compte');
    }
    try {
        const db = admin.firestore();
        ...
        if (userData.referredBy) {
            throw new functions.https.HttpsError('failed-precondition', 'Vous avez déjà un code de parrainage appliqué');
        }
        ...
        if (referrerId === userId) {
            throw new functions.https.HttpsError('invalid-argument', 'Vous ne pouvez pas vous parrainer vous-même');
        }
        ...
        throw new functions.https.HttpsError('internal', 'Erreur lors de l\'application du code');
    }
});
/**
