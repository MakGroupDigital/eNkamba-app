...
/**
 * Cloud Function pour traiter les paiements
 */
export const processPayment = functions.https.onCall(
  async (data: {
    ...
    const { payerId, amount, paymentMethod, recipientId, recipientIdentifier, qrCodeData, description } = data;
    ...
    try {
      ...
      if ((paymentMethod !== 'bluetooth' && paymentMethod !== 'wifi') && recipientIdentifier) {
        ...
        switch (paymentMethod) {
          ...
          case 'phone':
            ...
            break;
          case 'qrcode':
            // Pour QR code, on suppose que le code contient l'ID utilisateur
      ...
      const payerTransactionData: any = {
