...
const quickActions = [
  { icon: QrCode, label: 'Scanner', href: '/dashboard/scanner', isLucide: true },
  { icon: ArrowRightLeft, label: 'Payer/Recevoir', href: '/dashboard/pay-receive', isLucide: true },
  { icon: Send, label: 'Envoi', href: '/dashboard/send', isLucide: true },
  { icon: WalletIcon, label: 'Portefeuille', href: '/dashboard/wallet', isLucide: true },
];
      ...
      <div className="container mx-auto max-w-4xl p-4 space-y-6 animate-in fade-in duration-500 pt-20">
        ...
        <div className="grid grid-cols-4 gap-4 text-center">
          {quickActions.map(action => {
            ...
            return (
              <Link href={action.href} key={action.label} className="flex flex-col items-center gap-2 text-sm font-medium text-foreground hover:text-primary transition-colors group">
