    ...
    <>
      ...
      <div className="container mx-auto max-w-4xl p-4 space-y-6 animate-in fade-in duration-500 pt-24">
          ...
          {quickActions.map((action) => {
            ...
            return (
              <Link key={action.labelKey} href={action.href} className="flex flex-col items-center gap-2 group">
                ...
                <div className="flex items-center justify-center w-16 h-16 rounded-full bg-[#479B67] hover:bg-[#479B67] transition-all duration-300 hover:scale-110 flex-shrink-0 shadow-md text-white">
        ...
        <section className="space-y-3">
          <div className="group relative mx-auto flex w-full max-w-[500px] items-center justify-between overflow-hidden rounded-2xl bg-gradient-to-br from-[#479B67] to-[#479B67] px-4 py-3 text-white shadow-lg shadow-[#479B67]/20 ring-1 ring-white/20 animate-in fade-in-50 slide-in-from-bottom-3 duration-500">
