...
export default function AudioCallClient() {
  ...
  return (
    <div className="fixed inset-0 z-[220] flex w-full items-center justify-center overflow-hidden bg-gradient-to-br from-primary via-emerald-700 to-orange-500 text-white">
