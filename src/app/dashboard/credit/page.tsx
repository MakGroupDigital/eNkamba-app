...
const CreditBadgeIcon = ({ className = "h-6 w-6" }: { className?: string }) => (
  <svg viewBox="0 0 48 48" fill="none" className={className} aria-hidden="true">
    <rect x="7" y="13" width="34" height="24" rx="7" fill="#0A8B46" />
    ...
    <path d="M21 9h14a5 5 0 0 1 5 5v12" stroke="#0A8B46" strokeWidth="3" strokeLinecap="round" opacity="0.35" />
  </svg>
);

const ProjectCreditIcon = ({ className = "h-6 w-6" }: { className?: string }) => (
  <svg viewBox="0 0 48 48" fill="none" className={className} aria-hidden="true">
    <rect x="9" y="11" width="30" height="28" rx="8" fill="#0A8B46" />
    <path d="M16 31l6-6 4 4 7-9" stroke="white" strokeWidth="3.2" strokeLinecap="round" strokeLinejoin="round" />
    <circle cx="17" cy="18" r="3" fill="#0A8B46" />
    <circle cx="31" cy="18" r="3" fill="#FFA500" />
    <path d="M13 39h22" stroke="#0A8B46" strokeWidth="3" strokeLinecap="round" opacity="0.75" />
  </svg>
);

const EligibilityIcon = ({ className = "h-5 w-5" }: { className?: string }) => (
  <svg viewBox="0 0 40 40" fill="none" className={className} aria-hidden="true">
    <path d="M20 5l12 5v8c0 8-5 13-12 17C13 31 8 26 8 18v-8l12-5Z" fill="#0A8B46" />
  ...
  return (
    ...
    <div className="container mx-auto max-w-4xl p-3 space-y-4 animate-in fade-in duration-500 sm:p-4">
      ...
      <Card className="overflow-hidden border-[#0A8B46]/10 bg-white shadow-sm">
        <CardHeader className="border-b border-[#0A8B46]/10 bg-white px-4 py-3">
          <CardTitle className="font-headline flex items-center gap-2 text-lg text-[#0A8B46]">
            <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#0A8B46]/10 text-[#0A8B46]">
        ...
        <CardContent className="grid grid-cols-1 items-start gap-4 p-4 md:grid-cols-[1.1fr_0.9fr]">
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  className="h-12 flex-1 rounded-xl border-[#0A8B46]/20 bg-[#f7faf8] text-lg font-bold focus-visible:ring-[#0A8B46]"
                />
                <Select value={currency} onValueChange={(value) => setCurrency(value as Currency)}>
                  <SelectTrigger className="h-12 w-[100px] rounded-xl border-[#0A8B46]/20 bg-white font-semibold">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
            ...
            <Button 
              className="h-11 w-full rounded-xl bg-[#0A8B46] font-bold text-white hover:bg-[#0A8B46]" 
              size="lg"
            ...
            {isEligible !== null && (
              <Alert variant={isEligible ? "default" : "destructive"} className={cn(
                ...
                isEligible && "border-[#0A8B46]/20 bg-[#0A8B46]/5 dark:bg-primary/20"
              )}>
                {isEligible ? (
                  <>
                    <CheckCircle2 className="h-4 w-4 text-[#0A8B46]" />
                    <AlertTitle className="text-[#0A8B46] dark:text-primary">Éligible</AlertTitle>
                    <AlertDescription className="text-[#0A8B46] dark:text-primary">
          ...
          <div className="space-y-3">
            <Alert variant="default" className="rounded-2xl border-[#0A8B46]/20 bg-[#0A8B46]/5">
              <EligibilityIcon className="h-4 w-4" />
              <AlertTitle className="font-headline text-[#0A8B46]">Condition d'Éligibilité</AlertTitle>
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="rounded-2xl border border-[#0A8B46]/10 bg-[#f7faf8] p-3">
                <ShieldCheck className="mb-2 h-5 w-5 text-[#0A8B46]" />
                <p className="text-xs font-bold text-[#0A8B46]">Analyse IA</p>
              ...
              <div className="rounded-2xl border border-[#0A8B46]/10 bg-[#f7faf8] p-3">
                ...
                <p className="text-xs font-bold text-[#0A8B46]">Décaissement</p>
                <p className="mt-1 text-[11px] leading-4 text-muted-foreground">Versement vers wallet.</p>
              </div>
            </div>
          </div>
        </CardContent>
        <CardFooter className="border-t border-[#0A8B46]/10 px-4 py-3">
      ...
      {simulation && selectedOffer && (
        <Card className="animate-in fade-in-up overflow-hidden border-[#0A8B46]/30 bg-white shadow-sm">
          <CardHeader className="bg-[#0A8B46]/5 px-4 py-3">
            <CardTitle className="font-headline flex items-center gap-2 text-[#0A8B46]">
              <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#0A8B46]/10">
                <Calculator className="h-5 w-5 text-[#0A8B46]" />
              </span>
          ...
          <CardContent className="space-y-4 p-4">
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
              <div className="rounded-2xl border border-[#0A8B46]/10 bg-card p-3">
              ...
              <div className="rounded-2xl border border-[#0A8B46]/20 bg-[#0A8B46]/5 p-3">
            ...
            <div className="rounded-2xl border border-[#0A8B46]/20 bg-gradient-to-r from-[#0A8B46]/10 to-[#0A8B46]/5 p-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <Clock className="h-5 w-5 text-[#0A8B46]" />
                  <span className="font-semibold">Paiement mensuel</span>
                </div>
                <p className="text-2xl font-bold text-[#0A8B46]">
            ...
            {isEligible && (
              <Button 
                size="lg" 
                className="h-11 w-full rounded-xl bg-[#0A8B46] font-bold hover:bg-[#0A8B46]"
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <h2 className="font-headline text-lg font-bold text-[#0A8B46]">Nos offres de crédit</h2>
          <Badge className="rounded-full bg-[#0A8B46]/10 text-[#0A8B46] hover:bg-[#0A8B46]/10">2 offres</Badge>
        </div>
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
          {creditOffers.map((offer) => (
            <Card
              key={offer.id}
              className={cn(
                "cursor-pointer overflow-hidden border-[#0A8B46]/10 bg-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-md",
                selectedOffer?.id === offer.id && "border-[#0A8B46] shadow-md ring-1 ring-[#0A8B46]/20"
              )}
              ...
              <CardHeader className="p-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#0A8B46]/10">
                      {offer.id === 'project' ? <ProjectCreditIcon className="h-8 w-8" /> : <CreditBadgeIcon className="h-8 w-8" />}
                    </div>
                    <CardTitle className="text-base text-[#0A8B46]">
                      {offer.name}
                    </CardTitle>
                  </div>
                  {selectedOffer?.id === offer.id && (
                    <Badge className="bg-[#0A8B46]">Sélectionné</Badge>
                  )}
                </div>
                <CardDescription className="leading-5">{offer.description}</CardDescription>
                <div className="mt-2 grid grid-cols-3 gap-2 text-xs">
                  <span className="rounded-xl bg-[#f7faf8] px-2 py-2 font-semibold text-[#0A8B46]">Max {formatCurrency(offer.maxAmount, offer.currency)}</span>
                  <span className="rounded-xl bg-[#f7faf8] px-2 py-2 font-semibold text-[#0A8B46]">{offer.duration} jours</span>
                  <span className="rounded-xl bg-[#0A8B46]/10 px-2 py-2 font-bold text-[#0A8B46]">{offer.interestRate}% annuel</span>
                </div>
              </CardHeader>
              <CardFooter className="px-4 pb-4 pt-0">
                <Button variant="outline" className="h-10 w-full rounded-xl border-[#0A8B46]/25 text-[#0A8B46] hover:bg-[#0A8B46]/5" onClick={() => handleOfferSelect(offer)}>
            ...
            <div className="space-y-4 py-4">
              <div className="space-y-2 rounded-2xl bg-muted p-4">
                ...
                <div className="flex justify-between pt-2 border-t">
                  ...
                  <span className="font-bold text-[#0A8B46]">{formatCurrency(simulation.monthlyPayment, selectedOffer.currency)}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm font-semibold">Montant total à rembourser :</span>
                  <span className="font-bold text-[#0A8B46]">{formatCurrency(simulation.totalAmount, selectedOffer.currency)}</span>
                </div>
              </div>
              <Alert variant="default" className="rounded-2xl border-[#0A8B46]/20 bg-[#0A8B46]/5">
                <Info className="h-4 w-4 text-[#0A8B46]" />
                <AlertTitle className="text-sm font-semibold text-[#0A8B46]">Information</AlertTitle>
