...
function getOrderStatusMeta(status?: string) {
  ...
  if (['paid', 'success', 'completed'].includes(normalized)) {
    return { label: 'Payée', className: 'bg-[#073B9A]/12 text-[#073B9A]' };
  }
  ...
  if (['preparing', 'processing', 'pending'].includes(normalized)) {
    return { label: 'En préparation', className: 'bg-[#F51B2B]/10 text-[#F51B2B]' };
  }
...
function StoreDashboardMetric({
  ...
  const color = tone === 'amber' ? 'bg-[#fff7ed] text-[#F51B2B]' : 'bg-primary/10 text-primary';
    ...
    <article className="min-h-[7.1rem] rounded-[1.25rem] bg-white p-4 shadow-[0_10px_24px_rgba(15,23,42,0.06)] ring-1 ring-slate-100">
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0">
          ...
          <p className={`mt-1 text-xs font-bold ${tone === 'amber' ? 'text-[#F51B2B]' : 'text-primary'}`}>{detail}</p>
        </div>
      </div>
    </article>
  );
      ...
      <div className="min-h-screen bg-[#FFFFFF]">
        <div className="mx-auto flex min-h-screen max-w-3xl items-center px-4 py-8">
          <div className="w-full overflow-hidden rounded-[32px] border border-slate-200 bg-white shadow-xl">
            <div className="relative h-44 bg-[#073B9A]">
            ...
            <div className="space-y-4 p-5">
              ...
              <Button asChild className="h-12 w-full rounded-2xl bg-[#073B9A] hover:bg-[#073B9A]">
        ...
        <section className="rounded-[1.35rem] bg-white p-4 shadow-[0_12px_28px_rgba(15,23,42,0.07)] ring-1 ring-slate-100">
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex shrink-0 items-center gap-2">
              {isApproved ? (
                <Button asChild className="hidden h-12 rounded-2xl bg-primary px-5 font-black text-white hover:bg-[#073B9A] sm:inline-flex">
                  <Link href={storeUrl} target="_blank" rel="noreferrer">
                    Voir la vitrine <ExternalLink className="ml-2 h-4 w-4" />
                  </Link>
                </Button>
              ) : (
                <Badge className="hidden rounded-full border border-[#F51B2B]/30 bg-[#F51B2B]/10 px-3 py-1 text-[#F51B2B] sm:inline-flex">En attente</Badge>
              )}
              <button
                type="button"
                onClick={() => {
        ...
        <div className="sticky top-16 z-20">
          <div className="rounded-[1.35rem] bg-white/95 px-2 py-2 shadow-[0_10px_24px_rgba(15,23,42,0.07)] ring-1 ring-slate-100 backdrop-blur-xl">
            <div className="flex items-center justify-between gap-2 overflow-x-auto scrollbar-hide">
                ...
                return (
                  <button
                    ...
                    className={[
                      ...
                      active ? 'bg-[#073B9A] text-white shadow-sm' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-950',
                    ].join(' ')}
                  >
              ...
              {activeTab === 'media' ? (
                <Button size="sm" className="rounded-2xl bg-[#073B9A] hover:bg-[#073B9A]" onClick={saveProfile} disabled={isSaving}>
                  <Save className="h-4 w-4 mr-2" />
                  Sauver
                </Button>
              ) : activeTab === 'promo' ? (
                <Button size="sm" className="rounded-2xl bg-[#073B9A] hover:bg-[#073B9A]" onClick={savePromo} disabled={isSaving}>
                  <Save className="h-4 w-4 mr-2" />
                  Sauver
                </Button>
              ) : null}
        ...
        {!isApproved && (
          <Card className="border border-[#F51B2B]/30 bg-[#F51B2B]/10">
            <CardContent className="p-4">
              ...
              <p className="text-xs text-[#F51B2B] mt-1">
            ...
            <section className="overflow-hidden rounded-[1.35rem] bg-white shadow-[0_12px_28px_rgba(15,23,42,0.07)] ring-1 ring-slate-100">
              ...
              <div className="space-y-4 p-4">
                ...
                <div className="grid gap-2 sm:grid-cols-2">
                  {isApproved ? (
                    <Button asChild className="h-12 rounded-2xl bg-primary text-base font-black hover:bg-[#073B9A]">
                      <Link href={storeUrl} target="_blank" rel="noreferrer">
                        Ouvrir la vitrine <ExternalLink className="ml-2 h-4 w-4" />
                      </Link>
                    </Button>
                  ) : (
                    <Badge className="flex h-12 items-center justify-center rounded-2xl border border-[#F51B2B]/30 bg-[#F51B2B]/10 text-[#F51B2B]">En attente</Badge>
                  )}
                  ...
                  return (
                    <div key={product.id} className="grid grid-cols-[4rem_1fr_auto_auto] items-center gap-3 px-4 py-3">
                      ...
                      <div className="text-right text-xs">
                        ...
                        <p className={`text-lg font-black ${stock <= 10 && stock > 0 ? 'text-[#F51B2B]' : 'text-primary'}`}>{stock}</p>
                      </div>
          ...
          <Card className="rounded-[32px] border-slate-200 shadow-sm">
            <CardHeader>
              <CardTitle className="flex items-center justify-between gap-2">
                ...
                <Button asChild size="sm" className="rounded-2xl bg-[#073B9A] hover:bg-[#073B9A]">
        ...
        {activeTab === 'finance' ? (
          <Card className="rounded-[32px] border-slate-200 shadow-sm">
            ...
            <CardContent className="grid grid-cols-1 gap-3 md:grid-cols-3">
              <div className="rounded-3xl border border-slate-200 bg-[#073B9A] p-4 text-white">
              ...
              <div className="rounded-3xl border border-[#073B9A]/20 bg-[#073B9A]/10 p-4 md:col-span-3">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <Button asChild className="h-11 rounded-2xl bg-[#073B9A] hover:bg-[#073B9A]">
                  ...
                  <div className="mt-2 space-y-2">
                    {sellerOrders.slice(0, 5).map((o) => (
                      <div key={o.id} className="flex items-center justify-between rounded-2xl bg-slate-50 px-3 py-2 text-sm">
                        ...
                        <p className="font-black text-[#073B9A]">{Number(o.totalPrice || 0).toLocaleString()} {o.currency || 'CDF'}</p>
                      </div>
                    ))}
                  </div>
                )}
          ...
          <Card className="rounded-[32px] border-slate-200 shadow-sm">
            <CardHeader>
              <CardTitle className="flex items-center justify-between gap-3">
                ...
                <Badge className="rounded-full border border-[#073B9A]/20 bg-[#073B9A]/10 text-[#073B9A]">
                ...
                <div className="space-y-2">
                  {storeCustomers.map((client) => (
                    <div key={client.id} className="flex items-center justify-between gap-3 rounded-3xl border border-slate-200 bg-white p-3">
                      <div className="flex min-w-0 items-center gap-3">
                        <div className="grid h-12 w-12 shrink-0 place-items-center rounded-2xl bg-[#073B9A]/10">
                      ...
                      <div className="shrink-0 text-right">
                        <p className="text-sm font-black text-[#073B9A]">{client.total.toLocaleString()} CDF</p>
