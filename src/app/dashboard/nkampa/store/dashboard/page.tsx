...
function getOrderStatusMeta(status?: string) {
  ...
  if (['paid', 'success', 'completed'].includes(normalized)) {
    return { label: 'Payée', className: 'bg-[#479B67]/12 text-[#479B67]' };
  }
      ...
      <div className="min-h-screen bg-[#F6F8F7]">
        <div className="mx-auto flex min-h-screen max-w-3xl items-center px-4 py-8">
          <div className="w-full overflow-hidden rounded-[32px] border border-slate-200 bg-white shadow-xl">
            <div className="relative h-44 bg-[#479B67]">
            ...
            <div className="space-y-4 p-5">
              ...
              <Button asChild className="h-12 w-full rounded-2xl bg-[#479B67] hover:bg-[#0A4747]">
        ...
        <div className="sticky top-16 z-20">
          <div className="rounded-[1.35rem] bg-white/95 px-2 py-2 shadow-[0_10px_24px_rgba(15,23,42,0.07)] ring-1 ring-slate-100 backdrop-blur-xl">
            <div className="flex items-center justify-between gap-2 overflow-x-auto scrollbar-hide">
                ...
                return (
                  <button
                    ...
                    className={[
                      ...
                      active ? 'bg-[#479B67] text-white shadow-sm' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-950',
                    ].join(' ')}
                  >
              ...
              {activeTab === 'media' ? (
                <Button size="sm" className="rounded-2xl bg-[#479B67] hover:bg-[#0A4747]" onClick={saveProfile} disabled={isSaving}>
                  <Save className="h-4 w-4 mr-2" />
                  Sauver
                </Button>
              ) : activeTab === 'promo' ? (
                <Button size="sm" className="rounded-2xl bg-[#479B67] hover:bg-[#0A4747]" onClick={savePromo} disabled={isSaving}>
                  <Save className="h-4 w-4 mr-2" />
                  Sauver
                </Button>
              ) : null}
          ...
          <Card className="rounded-[32px] border-slate-200 shadow-sm">
            <CardHeader>
              <CardTitle className="flex items-center justify-between gap-2">
                ...
                <Button asChild size="sm" className="rounded-2xl bg-[#479B67] hover:bg-[#0A4747]">
                  ...
                  {myProducts.map((p) => (
                    <div key={p.id} className="overflow-hidden rounded-[26px] border border-slate-200 bg-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
                      <div className="relative aspect-square w-full bg-slate-100">
                        ...
                        <div className="absolute right-2 top-2 rounded-full bg-white/90 px-2 py-1 text-[10px] font-black text-[#479B67] shadow">
                          En vitrine
                        </div>
                      </div>
                      <div className="p-3">
                        ...
                        <p className="mt-1 text-sm font-black text-[#479B67]">
          ...
          <Card className="rounded-[32px] border-slate-200 shadow-sm">
            <CardHeader>
              <CardTitle className="flex items-center justify-between gap-3">
                ...
                <Button asChild className="rounded-2xl bg-[#479B67] hover:bg-[#0A4747]">
            ...
            <CardContent className="grid grid-cols-1 gap-3 md:grid-cols-3">
              <div className="rounded-3xl border border-slate-200 bg-[#479B67] p-4 text-white">
              ...
              <div className="rounded-3xl border border-[#479B67]/20 bg-[#479B67]/10 p-4 md:col-span-3">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <Button asChild className="h-11 rounded-2xl bg-[#479B67] hover:bg-[#0A4747]">
                  ...
                  <div className="mt-2 space-y-2">
                    {sellerOrders.slice(0, 5).map((o) => (
                      <div key={o.id} className="flex items-center justify-between rounded-2xl bg-slate-50 px-3 py-2 text-sm">
                        ...
                        <p className="font-black text-[#479B67]">{Number(o.totalPrice || 0).toLocaleString()} {o.currency || 'CDF'}</p>
                      </div>
                    ))}
                  </div>
                )}
          ...
          <Card className="rounded-[32px] border-slate-200 shadow-sm">
            <CardHeader>
              <CardTitle className="flex items-center justify-between gap-3">
                ...
                <Badge className="rounded-full border border-[#479B67]/20 bg-[#479B67]/10 text-[#479B67]">
                ...
                <div className="space-y-2">
                  {storeCustomers.map((client) => (
                    <div key={client.id} className="flex items-center justify-between gap-3 rounded-3xl border border-slate-200 bg-white p-3">
                      <div className="flex min-w-0 items-center gap-3">
                        <div className="grid h-12 w-12 shrink-0 place-items-center rounded-2xl bg-[#479B67]/10">
                      ...
                      <div className="shrink-0 text-right">
                        <p className="text-sm font-black text-[#479B67]">{client.total.toLocaleString()} CDF</p>
