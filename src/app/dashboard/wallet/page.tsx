    ...
    <div className="min-h-screen bg-[#f7faf8]">
      ...
      <div className="container mx-auto max-w-4xl p-3 sm:p-4 space-y-3 animate-in fade-in duration-500">
        ...
        <header className="flex items-center gap-3 pt-1 slide-up">
          ...
          <div>
            <h1 className="font-headline text-xl font-bold text-[#479B67] sm:text-2xl">
              Mon Portefeuille
            </h1>
        ...
        <div className="-mt-1 flex flex-col items-center gap-1 slide-up sm:-mt-2" style={{ animationDelay: '0.1s' }}>
          ...
          <div className="flex w-full max-w-[500px] justify-end px-1">
            <button
              ...
              className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-[#479B67]/20 bg-white text-[#479B67] shadow-sm transition hover:border-[#479B67]/40 hover:bg-[#479B67]/5 disabled:opacity-60"
            >
          ...
          <div className="w-full slide-up" style={{ animationDelay: '0.2s' }}>
            <div className="mx-auto flex max-w-sm items-center justify-between gap-2 rounded-2xl border border-[#479B67]/10 bg-white px-3 py-2 shadow-sm">
                  ...
                  <Link key={action.label} href={action.href} className="flex-1">
                    <div className="group relative flex cursor-pointer flex-col items-center gap-1.5">
                      <div className="relative">
                        <div className="relative rounded-xl border border-[#479B67]/20 bg-[#479B67]/10 p-2.5 text-[#479B67] transition duration-200 group-hover:-translate-y-0.5 group-hover:bg-[#479B67] group-hover:text-white sm:p-3">
                      ...
                      <span className="text-[0.65rem] sm:text-xs font-semibold text-foreground group-hover:text-[#479B67] transition-colors duration-300 text-center leading-tight">
                        {action.label}
                      </span>
                    </div>
                  </Link>
        ...
        <Card className="slide-up overflow-hidden border border-[#479B67]/10 bg-white shadow-sm" style={{ animationDelay: '0.25s' }}>
          <CardContent className="flex flex-col gap-3 p-3 sm:flex-row sm:items-center sm:justify-between sm:p-4">
            <div className="flex items-center gap-3">
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-[#479B67]/15 bg-[#479B67]/10">
                <Image
              ...
              <div className="min-w-0">
                <p className="text-[10px] font-black uppercase tracking-[0.16em] text-[#479B67]">Assistant financier IA</p>
                <h2 className="mt-0.5 text-base font-black text-[#479B67] sm:text-lg">Analyse intelligente du portefeuille</h2>
            ...
            <Button className="h-8 shrink-0 rounded-xl bg-[#479B67] px-3 text-xs font-bold text-white hover:bg-[#479B67] sm:h-9" asChild>
        ...
        <div className="grid grid-cols-1 gap-3 md:grid-cols-3 slide-up" style={{ animationDelay: '0.3s' }}>
          {/* Balance Overview */}
          <Card className="border-0 bg-[#479B67] text-white shadow-sm transition-shadow hover:shadow-md">
          ...
          {/* Account Status */}
          <Card className="border border-[#479B67]/10 bg-white shadow-sm transition-shadow hover:shadow-md">
            <CardContent className="p-3 sm:p-4">
              ...
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 rounded-full bg-[#479B67]"></div>
                <span className="text-sm font-medium text-[#479B67]">Actif</span>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="slide-up" style={{ animationDelay: '0.4s' }}>
          <Card className="border-[#479B67]/20 shadow-sm">
                  ...
                  walletTransactions.map((tx) => {
                    ...
                    return (
                      <div key={tx.id} className="group flex cursor-pointer items-center gap-3 rounded-xl p-2.5 transition-colors hover:bg-muted/50">
                        ...
                        <p className={`shrink-0 text-right text-sm font-bold ${tx.status === 'failed' || tx.status === 'pending' ? statusUI.amountClassName : isIncoming ? 'text-[#479B67]' : 'text-foreground'}`}>
