...
export default function AgentRelayMainPage() {
  ...
  const agentTypes = [
    {
      ...
      title: 'Agent Relais',
      icon: Handshake,
      color: 'bg-[#0A8B46] hover:bg-[#0A8B46]',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0A8B46] via-[#0A8B46] to-[#0A8B46]">
      {/* Header avec logo */}
      ...
      <div className="bg-white rounded-t-[40px] min-h-screen pt-8 px-6">
        ...
        <div className="text-center mb-8">
          <h1 className="text-[#0A8B46] text-2xl font-bold mb-2">
            Bienvenue
          </h1>
          <p className="text-[#0A8B46] text-lg font-semibold">
            ...
            return (
              <button
                ...
                className={`w-full p-5 rounded-2xl border-2 transition-all ${
                  isSelected
                    ? 'border-[#0A8B46] bg-[#0A8B46]/10 shadow-lg scale-[1.02]'
                    : 'border-gray-200 bg-white hover:border-[#0A8B46]/50 hover:shadow-md'
                }`}
              >
                <div className="flex items-center gap-4">
                  <div className={`h-14 w-14 rounded-xl ${
                    isSelected ? 'bg-[#0A8B46]' : 'bg-gray-100'
                  ...
                  {isSelected && (
                    <CheckCircle2 size={24} className="text-[#0A8B46]" />
                  )}
                </div>
              </button>
            );
        ...
        <div className="text-center mb-8 max-w-md mx-auto">
          ...
          <div className="flex items-center justify-center gap-8">
            <div className="flex flex-col items-center">
              <div className="h-16 w-16 rounded-xl bg-[#0A8B46]/10 flex items-center justify-center mb-2">
                <Shield size={32} className="text-[#0A8B46]" />
              </div>
            </div>
            
            <div className="flex flex-col items-center">
              <div className="h-16 w-16 rounded-xl bg-[#0A8B46]/10 flex items-center justify-center mb-2">
                <Fingerprint size={32} className="text-[#0A8B46]" />
              </div>
            </div>
            
            <div className="flex flex-col items-center">
              <div className="h-16 w-16 rounded-xl bg-[#0A8B46]/10 flex items-center justify-center mb-2">
                <CheckCircle2 size={32} className="text-[#0A8B46]" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="relative h-24 mb-8">
          <svg className="absolute bottom-0 w-full" viewBox="0 0 1440 120" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0 0C240 40 480 40 720 20C960 0 1200 0 1440 20V120H0V0Z" fill="#0A8B46" fillOpacity="0.3"/>
            <path d="M0 20C240 60 480 60 720 40C960 20 1200 20 1440 40V120H0V20Z" fill="#0A8B46" fillOpacity="0.2"/>
          </svg>
        </div>
        ...
        <div className="max-w-md mx-auto pb-8">
          <Button 
            ...
            className={`w-full h-14 rounded-xl text-lg font-semibold shadow-lg transition-all ${
              selectedType
                ? 'bg-[#0A8B46] hover:bg-[#0A8B46] text-white'
