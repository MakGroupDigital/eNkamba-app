      ...
      <div className="space-y-4">
        {isLoading ? (
          <Card className="rounded-2xl border border-gray-200">
            <CardContent className="p-10 flex items-center justify-center">
              <div className="text-center">
                <Loader2 className="h-8 w-8 animate-spin text-[#073B9A] mx-auto mb-2" />
          ...
          <>
            ...
            {referralLink && (
              <Card className="rounded-2xl border border-[#073B9A]/20 bg-gradient-to-br from-[#073B9A]/10 to-[#073B9A]/5">
                <CardHeader>
                  <CardTitle>Votre lien de parrainage</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="bg-white p-4 rounded-xl border border-[#073B9A]/20 break-all font-mono text-sm">
                    {referralLink}
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <Button
                      onClick={shareLink}
                      className="h-12 rounded-xl bg-[#073B9A] hover:bg-[#073B9A] text-white"
                    >
            ...
            {referralCode && (
              <Card className="rounded-2xl border border-gray-200">
                ...
                <CardContent className="space-y-4">
                  <div className="bg-gradient-to-r from-[#073B9A] to-[#073B9A] p-8 rounded-2xl text-center">
              ...
              <Card className="rounded-2xl border border-gray-200">
                <CardContent className="p-6">
                  ...
                  <Button
                    ...
                    className="mt-4 h-12 rounded-xl bg-[#073B9A] hover:bg-[#073B9A] text-white"
                  >
                    Recharger
                  </Button>
                </CardContent>
