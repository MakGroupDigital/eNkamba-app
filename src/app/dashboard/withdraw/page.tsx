        ...
        {step === 'method' && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              <CardContent className="pt-6">
                <div className="flex flex-col items-center gap-4 text-center">
                  <div className="p-4 rounded-full bg-gradient-to-br from-[#25543A] to-[#25543A]">
            ...
            <CardContent className="space-y-4">
              ...
              {withdrawalMethod === 'mobile_money' && (
                <>
                  ...
                  <div className="rounded-lg border border-[#25543A]/20 bg-[#25543A]/5 p-4 text-sm">
                    <p className="mb-2 font-semibold text-[#25543A]">Mobile Money RDC</p>
              ...
              {withdrawalMethod === 'agent' && (
                <>
                  ...
                  <div className="rounded-lg border border-[#25543A]/20 bg-[#25543A]/5 p-4 text-sm">
                    <p className="mb-2 font-semibold text-[#25543A]">Agent eNkamba</p>
                    <p className="text-muted-foreground">
