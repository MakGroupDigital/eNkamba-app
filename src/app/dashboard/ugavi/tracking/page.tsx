    ...
    const receiptHtml = `
      ...
      <head>
        ...
        <style>
          ...
          .hero { background: linear-gradient(135deg, #009058, #F28C28); color: white; padding: 28px; border-radius: 20px 20px 0 0; }
          ...
          .timeline-item { border-left: 3px solid #009058; padding: 0 0 14px 14px; margin-left: 6px; }
        </style>
      </head>
      <body>
        <div class="hero">
