    ...
    const receiptHtml = `
      ...
      <head>
        ...
        <style>
          ...
          .hero { background: linear-gradient(135deg, #073B9A, #F28C28); color: white; padding: 28px; border-radius: 20px 20px 0 0; }
          ...
          .timeline-item { border-left: 3px solid #073B9A; padding: 0 0 14px 14px; margin-left: 6px; }
        </style>
      </head>
      <body>
        <div class="hero">
                ...
                <div className="rounded-xl border border-slate-200 bg-slate-50 p-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <Button
                      ...
                      size="sm"
                      variant="outline"
                      className="rounded-full border-[#F51B2B]/30 text-[#F51B2B]"
                      disabled={isUpdatingStatus}
