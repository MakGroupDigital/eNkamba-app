    ...
    if (data.startsWith('ENK')) {
      ...
      if (parts.length >= 2) {
        return {
          ...
          fullName: parts[1] || 'Utilisateur Kenz',
          email: parts[2],
          isValid: true
        };
      }
        ...
        img.onload = async () => {
          ...
          if (code) {
            ...
            if (data?.isValid) {
              ...
              toast({ title: "QR code invalide", description: "Ce n'est pas un code Kenz", variant: "destructive" });
            }
          } else {
    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: 'Lien d\'encaissement Kenz',
      ...
      <div className="min-h-screen bg-gradient-to-b from-background to-muted/50">
        <div className="container mx-auto max-w-4xl p-4 space-y-6 pt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Mode Demander */}
            <Card className="border-2 border-[#073B9A]/20 hover:border-[#073B9A]/50 cursor-pointer transition-all hover:shadow-lg"
              onClick={() => { setMode('demand'); setViewMode('menu'); }}>
              <CardHeader className="bg-gradient-to-r from-[#073B9A]/10 to-transparent">
                <CardTitle className="flex items-center gap-2">
                  <QrCode className="w-5 h-5 text-[#073B9A]" />
            ...
            <Card className="border-2 border-[#073B9A]/20 hover:border-[#073B9A]/50 cursor-pointer transition-all hover:shadow-lg"
              ...
              <CardHeader className="bg-gradient-to-r from-[#073B9A]/10 to-transparent">
                <CardTitle className="flex items-center gap-2">
                  <Download className="w-5 h-5 text-[#073B9A]" />
                  Encaisser
                </CardTitle>
              </CardHeader>
              <CardContent className="pt-6">
            ...
            <Card className="overflow-hidden">
              <CardContent className="p-0 relative">
                ...
                <div className="absolute inset-0 pointer-events-none">
                  <div className="absolute inset-0 border-2 border-[#073B9A] opacity-50 rounded-lg" />
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-48 h-48 border-4 border-[#073B9A]" />
                </div>
              </CardContent>
            </Card>
      ...
      return (
        <div className="min-h-screen bg-gradient-to-b from-background to-muted/50">
          <div className="container mx-auto max-w-4xl p-4 space-y-6 pt-20">
            ...
            <Card className="border-[#073B9A]/50 bg-[#073B9A]/5">
              <CardHeader>
                <CardTitle className="text-lg flex items-center gap-2">
                  <CheckCircle2 className="w-5 h-5 text-[#073B9A]" />
                  Bénéficiaire trouvé
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-6">
                ...
                <div className="bg-muted p-4 rounded-lg space-y-2">
                  ...
                  <p className="text-2xl font-bold text-[#073B9A]">{amount} {currency}</p>
                </div>
        ...
        <div className="min-h-screen bg-gradient-to-b from-background to-muted/50">
          <div className="container mx-auto max-w-4xl p-4 space-y-6 pt-20">
            <div className="text-center space-y-4">
              <div className="w-16 h-16 rounded-full bg-[#073B9A]/20 flex items-center justify-center mx-auto animate-pulse">
                <CheckCircle2 className="w-8 h-8 text-[#073B9A]" />
              </div>
