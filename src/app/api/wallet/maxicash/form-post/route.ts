...
<html lang="fr">
  <head>
    ...
    <style>
      body{font-family:system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;margin:0;min-height:100vh;display:grid;place-items:center;background:#f7fbf9;color:#479B67}
      ...
      .spinner{width:34px;height:34px;border:4px solid #d7eee4;border-top-color:#479B67;border-radius:50%;margin:0 auto 16px;animation:spin .9s linear infinite}
      @keyframes spin{to{transform:rotate(360deg)}}
      button{margin-top:14px;border:0;border-radius:8px;background:#479B67;color:white;font-weight:700;padding:10px 14px}
    </style>
  </head>
  <body>
    <div class="box">
