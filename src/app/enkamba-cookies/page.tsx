    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <div className="bg-white border-b sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <h1 className="text-2xl font-bold">Politique relative aux cookies - eNKAMBA</h1>
        </div>
      </div>
          ...
          <CardContent className="p-8 space-y-6">
            <section>
              ...
              <p className="text-gray-700">
                Un cookie est un petit fichier texte stocké sur votre appareil lorsque vous visitez la plateforme eNKAMBA. Les cookies nous aident à reconnaître votre appareil et à améliorer votre expérience de navigation sur notre plateforme ecommerce.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-bold mb-4">2. Types de cookies utilisés par eNKAMBA</h2>
              <div className="space-y-4">
                <div>
                  <h3 className="font-bold text-gray-900 mb-2">Cookies essentiels</h3>
                  <p className="text-gray-700">
                    Ces cookies sont nécessaires au fonctionnement de la plateforme eNKAMBA. Ils incluent les cookies de session, les cookies d\'authentification et les cookies de sécurité pour protéger votre compte partenaire.
                  </p>
                </div>
                <div>
                  <h3 className="font-bold text-gray-900 mb-2">Cookies de performance</h3>
                  <p className="text-gray-700">
                    Ces cookies nous aident à comprendre comment vous utilisez la plateforme eNKAMBA et à améliorer ses performances. Ils collectent des données anonymes sur l\'utilisation.
                  </p>
                </div>
                <div>
                  <h3 className="font-bold text-gray-900 mb-2">Cookies de fonctionnalité</h3>
                  <p className="text-gray-700">
                    Ces cookies mémorisent vos préférences et vos choix pour personnaliser votre expérience sur la plateforme ecommerce eNKAMBA.
                  </p>
                </div>
                <div>
            ...
            <section>
              ...
              <p className="text-gray-700">
                Nous utilisons également des cookies tiers de services comme Google Analytics pour analyser le trafic de la plateforme eNKAMBA et améliorer nos services. Ces services peuvent avoir leurs propres politiques de confidentialité.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-700">
                ...
                <li>Utiliser les outils de gestion des cookies sur la plateforme eNKAMBA</li>
                <li>Vous désabonner des cookies de marketing</li>
                <li>Utiliser le mode de navigation privée de votre navigateur</li>
              </ul>
              <p className="text-gray-700 mt-4 text-sm">
                Veuillez noter que désactiver certains cookies peut affecter la fonctionnalité de la plateforme eNKAMBA.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-bold mb-4">5. Cookies spécifiques utilisés par eNKAMBA</h2>
            ...
            <section>
              ...
              <p className="text-gray-700">
                La plupart des cookies eNKAMBA expirent après une période définie (généralement 30 jours à 1 an). Les cookies de session expirent à la fermeture de votre navigateur. Vous pouvez les supprimer manuellement à tout moment.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700">
                Lors de votre première visite sur la plateforme eNKAMBA, nous vous demandons de consentir à l\'utilisation de cookies. Vous pouvez modifier vos préférences à tout moment dans les paramètres de votre compte partenaire.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700">
                Guangzhou eNKAMBA International Company CO., Ltd respecte le Règlement Général sur la Protection des Données (RGPD) concernant l\'utilisation des cookies. Nous obtenons votre consentement explicite avant d\'utiliser des cookies non essentiels.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700">
                Nous pouvons mettre à jour cette politique relative aux cookies de temps en temps. Les modifications entreront en vigueur dès leur publication sur la plateforme eNKAMBA.
              </p>
            </section>
