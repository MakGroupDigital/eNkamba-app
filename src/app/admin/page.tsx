    ...
    <main className="min-h-screen bg-[#F7FAF8] text-slate-950">
      <div className="mx-auto flex max-w-7xl flex-col gap-6 px-4 py-5 sm:px-6 lg:px-8">
          ...
          <div className="relative grid gap-5 p-4 lg:grid-cols-[1fr_310px] lg:p-5">
            <div className="min-w-0">
              <div className="mb-4 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                <div>
                  <Badge className="bg-[#479B67]/15 text-[#479B67] hover:bg-[#479B67]/15">
                ...
                <div className="grid grid-cols-3 gap-2 text-center">
                  <div className="rounded-[8px] border border-white/10 bg-white/5 px-3 py-2">
                    <p className="text-lg font-bold text-[#479B67]">99.8%</p>
            ...
            <aside className="grid gap-3">
              <div className="rounded-[8px] border border-white/10 bg-white/[0.07] p-4 backdrop-blur">
                <div className="flex items-start justify-between gap-3">
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-[0.18em] text-[#479B67]">Point selectionne</p>
                  ...
                  <Badge className="bg-[#479B67] hover:bg-[#479B67]">{selectedPoint.status}</Badge>
                </div>
        ...
        <header className="flex flex-col gap-4 rounded-[8px] border border-primary/10 bg-white px-4 py-4 shadow-sm md:flex-row md:items-center md:justify-between">
          <div>
            <div className="flex items-center gap-2 text-sm font-semibold text-[#479B67]">
          ...
          <div className="flex flex-col gap-2 sm:flex-row">
            ...
            <Button asChild className="gap-2 bg-[#479B67] hover:bg-[#479B67]">
        ...
        <section className="rounded-[8px] border border-primary/10 bg-white p-4 shadow-sm">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            ...
            <Badge className="w-fit bg-[#479B67] hover:bg-[#479B67]">Pages dediees</Badge>
          </div>
          ...
          <div className="mt-4 grid gap-3 md:grid-cols-2 xl:grid-cols-5">
            {[
              ...
              return (
                <Link key={item.href} href={item.href} className="group rounded-[8px] border border-slate-200 p-4 transition hover:border-[#479B67]/50 hover:shadow-md">
                  <div className={cn('flex h-11 w-11 items-center justify-center rounded-[8px]', item.tone)}>
                    <Icon className="h-5 w-5" />
                  </div>
                  <h3 className="mt-3 font-bold">{item.title}</h3>
                  <p className="mt-1 text-sm leading-6 text-slate-500">{item.text}</p>
                  <span className="mt-4 flex items-center gap-1 text-sm font-semibold text-[#479B67]">
                    Ouvrir
        ...
        <section className="grid gap-6 xl:grid-cols-3">
          <div className="grid gap-4">
            <Card className="rounded-[8px] border-primary/10 shadow-sm">
              <CardHeader className="pb-3">
                <CardTitle className="flex items-center gap-2 text-lg">
                  <KeyRound className="h-5 w-5 text-[#479B67]" />
                  Acces et roles
                </CardTitle>
              </CardHeader>
            ...
            <Card className="rounded-[8px] border-primary/10 shadow-sm">
              <CardHeader className="pb-3">
                <CardTitle className="flex items-center gap-2 text-lg">
                  <Users className="h-5 w-5 text-[#479B67]" />
                  Types de comptes
                </CardTitle>
              </CardHeader>
          ...
          <Card className="rounded-[8px] border-primary/10 shadow-sm xl:col-span-2">
            <CardHeader className="pb-3">
              <CardTitle className="flex items-center gap-2 text-lg">
                <LockKeyhole className="h-5 w-5 text-[#479B67]" />
            ...
            <CardContent className="space-y-4">
              <div className="rounded-[8px] border border-primary/10 bg-primary/5 p-4">
                <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                  ...
                  <Badge className="w-fit bg-[#479B67] hover:bg-[#479B67]">Propagation globale</Badge>
                </div>
              </div>
              ...
              <div className="mt-4 space-y-3">
                {[
                  ...
                  <div key={user.name} className="flex items-center justify-between rounded-[8px] border border-slate-200 p-3">
                    <div className="flex items-center gap-3">
                      <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#479B67]/10 text-[#479B67]">
              ...
              {modules.map((module) => {
                ...
                return (
                  <Link
                    key={module.name}
                    href={module.href}
                    className="group rounded-[8px] border border-slate-200 p-4 transition hover:border-[#479B67]/50 hover:shadow-md"
                  >
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex items-center gap-3">
                        <div
                      ...
                      <ChevronRight className="h-5 w-5 text-slate-300 transition group-hover:translate-x-1 group-hover:text-[#479B67]" />
                    </div>
