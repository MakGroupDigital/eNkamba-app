        ...
        <CardContent className="pt-6">
          {isProcessing ? (
            <div className="flex flex-col items-center gap-4 py-8">
              <Loader2 className="w-16 h-16 text-[#009058] animate-spin" />
            ...
            <div className="flex flex-col items-center gap-4 py-8">
              ...
              <Button
                ...
                className="mt-4 bg-[#009058] hover:bg-[#009058]"
              >
            ...
            <div className="flex flex-col items-center gap-4 py-8">
              <CheckCircle className="w-16 h-16 text-[#009058]" />
              <h2 className="text-2xl font-bold text-[#009058]">Paiement réussi!</h2>
              <p className="text-sm text-muted-foreground text-center">
              ...
              <div className="w-full space-y-3 mt-4">
                ...
                <div className="bg-[#009058]/10 border border-[#009058]/30 rounded-lg p-4">
                  <p className="text-sm text-center text-muted-foreground mb-1">
                    Montant ajouté (CDF)
                  </p>
                  <p className="text-2xl font-bold text-center text-[#009058]">
              ...
              <Button
                onClick={handleGoHome}
                className="mt-4 w-full bg-[#009058] hover:bg-[#009058]"
              >
                <Home className="w-4 h-4 mr-2" />
                Retour à l'accueil
              </Button>
