...
export default function NotFound() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-[#479B67]/5 to-background flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-2xl border-[#479B67]/20 shadow-2xl">
        <CardContent className="p-8 sm:p-12">
          {/* Icône 404 animée */}
          <div className="flex justify-center mb-8">
            <div className="relative">
              {/* Cercles pulsants */}
              <div className="absolute inset-0 rounded-full bg-[#479B67]/20 pulse-ring"></div>
              <div className="absolute inset-0 rounded-full bg-[#479B67]/20 pulse-ring" style={{ animationDelay: '1s' }}></div>
              
              {/* Icône principale */}
              <div className="relative bg-gradient-to-br from-[#479B67] to-[#479B67] rounded-full p-8 float-animation">
          ...
          <div className="text-center mb-6">
            <h1 className="font-headline text-6xl sm:text-8xl font-bold bg-gradient-to-r from-[#479B67] to-[#479B67] bg-clip-text text-transparent mb-4">
              404
            </h1>
          ...
          {autoRedirect && (
            <div className="text-center mb-6">
              <p className="text-sm text-muted-foreground">
                ...
                <span className="font-bold text-[#479B67]">{countdown}</span> secondes
              </p>
              <button
          ...
          <div className="mt-8 pt-6 border-t border-border">
            <p className="text-sm font-semibold text-foreground mb-3 flex items-center gap-2">
              <Search className="w-4 h-4 text-[#479B67]" />
              Pages populaires
            </p>
            <div className="grid grid-cols-2 gap-2 text-sm">
              <Link 
                href="/dashboard/wallet" 
                className="text-muted-foreground hover:text-[#479B67] transition-colors"
              >
                → Portefeuille
              </Link>
              <Link 
