      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            <Settings className="w-5 h-5 text-[#479B67]" />
        ...
        <Tabs defaultValue="info" className="w-full">
          ...
          <TabsContent value="info" className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 bg-[#479B67]/10 rounded-lg border border-[#479B67]/20">
                <p className="text-sm text-muted-foreground">Membres</p>
                <p className="text-2xl font-bold text-[#479B67]">{groupData.participants.length}</p>
              </div>
            ...
            <div className="flex items-center justify-between">
              ...
              {isAdmin && (
                <Button
                  ...
                  size="sm"
                  className="bg-[#479B67] hover:bg-[#479B67] gap-2"
                >
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <Avatar>
                        <AvatarFallback className="bg-[#479B67] text-white">
          ...
          <TabsContent value="invite" className="space-y-4">
            {/* QR Code */}
            <div className="flex flex-col items-center gap-4 p-6 bg-gradient-to-br from-[#479B67]/10 to-[#479B67]/5 rounded-lg border border-[#479B67]/20">
              ...
              <div className="space-y-3">
                      ...
                      return (
                        <div
                          ...
                          className={`flex items-center justify-between p-3 rounded-lg cursor-pointer transition-colors ${
                            isSelected 
                              ? 'bg-[#479B67]/20 border-2 border-[#479B67]' 
                        ...
                        >
                          ...
                          {isSelected && <Check className="w-5 h-5 text-[#479B67]" />}
                        </div>
                      );
                    })
                  )}
                ...
                {selectedContacts.length > 0 && (
                  <Button
                    ...
                    className="w-full bg-[#479B67] hover:bg-[#479B67] gap-2"
                  >
                    {isAddingMembers ? (
                      <>
