      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            <Settings className="w-5 h-5 text-[#25543A]" />
        ...
        <Tabs defaultValue="info" className="w-full">
          ...
          <TabsContent value="info" className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 bg-[#25543A]/10 rounded-lg border border-[#25543A]/20">
                <p className="text-sm text-muted-foreground">Membres</p>
                <p className="text-2xl font-bold text-[#25543A]">{groupData.participants.length}</p>
              </div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <Avatar>
                        <AvatarFallback className="bg-[#25543A] text-white">
          ...
          <TabsContent value="invite" className="space-y-4">
            {/* QR Code */}
            <div className="flex flex-col items-center gap-4 p-6 bg-gradient-to-br from-[#25543A]/10 to-[#25543A]/5 rounded-lg border border-[#25543A]/20">
              ...
              <div className="space-y-3">
                      ...
                      return (
                        <div
                          ...
                          className={`flex items-center justify-between p-3 rounded-lg cursor-pointer transition-colors ${
                            isSelected 
                              ? 'bg-[#25543A]/20 border-2 border-[#25543A]' 
                        ...
                        >
                          ...
                          {isSelected && <Check className="w-5 h-5 text-[#25543A]" />}
                        </div>
                      );
                    })
                  )}
                ...
                {selectedContacts.length > 0 && (
                  <Button
                    ...
                    className="w-full bg-[#25543A] hover:bg-[#25543A] gap-2"
                  >
                    {isAddingMembers ? (
                      <>
