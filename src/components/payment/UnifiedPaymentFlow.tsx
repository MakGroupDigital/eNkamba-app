    ...
    <div className="space-y-6">
      ...
      {step !== 'success' && (
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="font-headline text-2xl font-bold text-[#25543A]">{customLabel}</h2>
                ...
                <CardContent className="pt-6">
                  <div className="flex flex-col items-center gap-4 text-center">
                    <div className="p-4 rounded-full bg-[#25543A]/20">
                      <Icon className="w-8 h-8 text-[#25543A]" />
                    </div>
                    <div>
          ...
          <CardContent className="space-y-4">
            {paymentMethod === 'qrcode' ? (
              <>
                ...
                {!isScanning ? (
                  <Button onClick={startQRScanning} className="w-full bg-[#25543A] hover:bg-[#25543A] gap-2">
        ...
        <Card className="border-primary/20 bg-primary/5">
          <CardContent className="pt-6">
            <div className="flex flex-col items-center gap-4 text-center">
              ...
              <div>
                <h3 className="font-semibold text-lg text-primary">Paiement Effectué!</h3>
