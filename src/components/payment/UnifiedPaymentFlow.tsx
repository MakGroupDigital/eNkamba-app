    ...
    <div className="space-y-6">
      ...
      {step !== 'success' && (
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="font-headline text-2xl font-bold text-[#0A8B46]">{customLabel}</h2>
          ...
          <CardContent className="space-y-4">
            {paymentMethod === 'qrcode' ? (
              <>
                ...
                {!isScanning ? (
                  <Button onClick={startQRScanning} className="w-full bg-[#0A8B46] hover:bg-[#0A8B46] gap-2">
