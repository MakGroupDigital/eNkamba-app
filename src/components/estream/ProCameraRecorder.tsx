      ...
      <div className="fixed inset-0 bg-black z-50 flex flex-col">
        ...
        <div className="bg-gray-900 border-t border-gray-800 p-4 space-y-3 max-h-48 overflow-y-auto">
          <input
            ...
            className="w-full bg-gray-800 text-white px-4 py-2 rounded-lg outline-none focus:ring-2 focus:ring-[#25543A] text-sm"
          />
          ...
          <textarea
            ...
            className="w-full bg-gray-800 text-white px-4 py-2 rounded-lg outline-none focus:ring-2 focus:ring-[#25543A] text-sm resize-none h-20"
          />
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="flex-1 bg-gradient-to-r from-[#25543A] to-primary hover:from-[#25543A] hover:to-primary disabled:opacity-50 text-white py-2 rounded-lg transition-all flex items-center justify-center gap-2 font-semibold text-sm"
            >
              <Send size={16} />
          ...
          <div className="absolute inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
            <div className="bg-gray-900 rounded-2xl p-6 max-w-sm w-full space-y-4 border border-gray-800">
              ...
              <button
                ...
                className="w-full bg-[#25543A] hover:bg-[#25543A] text-white py-2 rounded-lg transition-all font-semibold"
              >
                Fermer
              </button>
            </div>
