...
function CommerceProducts({
  ...
  return (
    <div className="rounded-3xl border border-[#0A8B46] bg-white p-5 shadow-sm">
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button
          type="button"
          onClick={onAdd}
          className="rounded-2xl bg-[#0A8B46] px-4 py-3 text-sm font-bold text-white transition hover:bg-[#0A4747]"
        >
          + Ajouter un produit
        </button>
      </div>
      {isLoading ? (
        <div className="rounded-3xl border border-dashed border-[#0A8B46]/30 bg-[#0A8B46]/5 px-5 py-12 text-center text-sm font-bold text-muted-foreground">
        ...
        <div className="grid grid-cols-2 gap-3 md:grid-cols-3 lg:grid-cols-4">
          {products.map((product) => (
            <div
              ...
              className="overflow-hidden rounded-[24px] border border-slate-200 bg-white text-left shadow-sm transition hover:-translate-y-0.5 hover:border-[#0A8B46]/40 hover:shadow-md"
            >
              <div className="relative aspect-square bg-slate-100">
                ...
                />
                <span className="absolute left-2 top-2 rounded-full bg-white/95 px-2 py-1 text-[10px] font-black text-[#0A8B46] shadow">
              ...
              <div className="space-y-1.5 p-3">
                ...
                <p className="text-sm font-black text-[#0A8B46]">
                ...
                <div className="mt-2 grid grid-cols-2 gap-2">
                  <span className="inline-flex items-center justify-center gap-1 rounded-xl bg-[#0A8B46]/10 px-2 py-2 text-[11px] font-black text-[#0A8B46]">
