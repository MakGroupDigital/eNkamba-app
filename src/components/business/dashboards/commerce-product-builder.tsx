...
export function CommerceProductBuilder({
  ...
  return (
    <div className="space-y-5">
      <div className="overflow-hidden rounded-[30px] border border-[#32BB78]/25 bg-white shadow-sm">
        <div className="bg-[#32BB78] px-4 py-4 text-white">
          <div className="flex items-center gap-3">
            ...
            <div className="hidden h-12 w-12 place-items-center rounded-2xl bg-white sm:grid">
              <PackagePlus className="h-6 w-6 text-[#32BB78]" />
            </div>
          </div>
        ...
        <div className="grid gap-4 p-4 lg:grid-cols-[0.85fr_1.15fr]">
          <section className="space-y-4 rounded-[26px] border border-slate-200 bg-slate-50 p-4">
            <div className="flex items-start gap-3">
              <div className="grid h-11 w-11 shrink-0 place-items-center rounded-2xl bg-[#32BB78]/10 text-[#32BB78]">
            ...
            <div className="rounded-2xl border border-[#32BB78]/20 bg-white p-4">
              <div className="mb-3 flex items-center gap-2">
                <FileCheck2 className="h-4 w-4 text-[#32BB78]" />
            ...
            <label className="block cursor-pointer rounded-[24px] border-2 border-dashed border-[#32BB78]/30 bg-white p-5 text-center transition hover:border-[#32BB78]">
              <div className="mx-auto grid h-12 w-12 place-items-center rounded-2xl bg-[#32BB78]/10">
                <UploadCloud className="h-6 w-6 text-[#32BB78]" />
              </div>
            ...
            {listingType === 'digital' ? (
              <div className="rounded-[24px] border border-[#32BB78]/20 bg-white p-4">
                <div className="mb-3 flex items-start gap-3">
                  <div className="grid h-10 w-10 shrink-0 place-items-center rounded-2xl bg-[#32BB78]/10 text-[#32BB78]">
                ...
                <label className="block cursor-pointer rounded-2xl border-2 border-dashed border-[#32BB78]/30 bg-[#32BB78]/5 p-4 text-center transition hover:border-[#32BB78]">
                  <FileArchive className="mx-auto h-7 w-7 text-[#32BB78]" />
                  ...
                  <div className="mt-3 space-y-2">
                    {digitalFiles.map((file) => (
                      <div key={`${file.name}-${file.size}`} className="flex items-center justify-between gap-3 rounded-2xl bg-slate-50 px-3 py-2">
                        ...
                        <span className="rounded-full bg-[#32BB78]/10 px-2 py-1 text-[10px] font-black text-[#32BB78]">Cloudinary</span>
                      </div>
                    ))}
                  </div>
                ) : null}
          ...
          <section className="space-y-4">
            ...
            <div className="rounded-[24px] border border-slate-200 bg-slate-50 p-4">
              <div className="mb-3 flex items-center gap-2">
                <Boxes className="h-4 w-4 text-[#32BB78]" />
            ...
            <div className="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
              ...
              <Button type="button" className="rounded-2xl bg-[#32BB78] hover:bg-[#0A4747]" onClick={handleSubmit} disabled={isSubmitting}>
  ...
  return (
    <label className="block space-y-2">
      <span className="flex items-center gap-2 text-xs font-black uppercase tracking-wide text-slate-600">
        {label}
        {required ? <Badge className="rounded-full bg-[#32BB78]/10 px-2 py-0.5 text-[10px] text-[#32BB78] hover:bg-[#32BB78]/10">requis</Badge> : null}
      </span>
      {children}
    </label>
  );
