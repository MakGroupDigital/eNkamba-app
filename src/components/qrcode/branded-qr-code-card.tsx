...
export async function createBrandedQRCodeDataUrl({
  ...
  topLine.addColorStop(0, '#0A8B46');
  topLine.addColorStop(0.55, '#0A8B46');
  ...
  if (!centerImageDrawn) {
    context.fillStyle = isPayment ? '#0A8B46' : '#0A8B46';
  ...
  return (
    <div
      className={cn(
        ...
        isPayment
          ? 'border-[#0A8B46]/25 bg-[radial-gradient(circle_at_20%_12%,rgba(10,139,70,0.18),transparent_34%),linear-gradient(145deg,#ffffff,#effbf4)]'
          : 'border-[#0A8B46]/20 bg-[radial-gradient(circle_at_78%_16%,rgba(10,139,70,0.16),transparent_34%),linear-gradient(145deg,#ffffff,#f2fbf8)]',
      )}
    >
      <div className="pointer-events-none absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-[#0A8B46] via-[#0A8B46] to-[#FFA500]" />
