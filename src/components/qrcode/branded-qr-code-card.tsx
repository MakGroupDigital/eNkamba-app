...
export async function createBrandedQRCodeDataUrl({
  ...
  topLine.addColorStop(0, '#25543A');
  topLine.addColorStop(0.55, '#25543A');
  ...
  if (!centerImageDrawn) {
    context.fillStyle = isPayment ? '#25543A' : '#25543A';
  ...
  return (
    <div
      className={cn(
        ...
        isPayment
          ? 'border-[#25543A]/25 bg-[radial-gradient(circle_at_20%_12%,rgba(37,84,58,0.18),transparent_34%),linear-gradient(145deg,#ffffff,#effbf4)]'
          : 'border-[#25543A]/20 bg-[radial-gradient(circle_at_78%_16%,rgba(37,84,58,0.16),transparent_34%),linear-gradient(145deg,#ffffff,#f2fbf8)]',
      )}
    >
      <div className="pointer-events-none absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-[#25543A] via-[#25543A] to-[#FF8C00]" />
