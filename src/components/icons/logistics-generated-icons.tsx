...
const BadgeBase = ({ size = 24, className, children }: IconProps & { children: ReactNode }) => (
  ...
  >
    <circle cx="24" cy="24" r="22" fill="#0A8B46" />
    <circle cx="24" cy="24" r="20" fill="#0A8B46" fillOpacity="0.78" />
...
export const LogisticsStandardIcon = ({ className, size = 24 }: IconProps) => (
  <BadgeBase className={className} size={size}>
    ...
    <circle cx="16" cy="33" r="3" fill="#0A8B46" />
    <circle cx="29" cy="33" r="3" fill="#0A8B46" />
  </BadgeBase>
);
...
export const LogisticsTrackingIcon = ({ className, size = 24 }: IconProps) => (
  <BadgeBase className={className} size={size}>
    ...
    <rect x="16" y="15" width="10" height="2" rx="1" fill="#0A8B46" />
    <rect x="16" y="20" width="14" height="2" rx="1" fill="#0A8B46" />
    <circle cx="24" cy="30" r="5" fill="#0A8B46" />
...
export const LogisticsRelayIcon = ({ className, size = 24 }: IconProps) => (
  <BadgeBase className={className} size={size}>
    ...
    <rect x="21" y="28" width="6" height="8" rx="1" fill="#0A8B46" />
  </BadgeBase>
);
...
export const LogisticsAgencyIcon = ({ className, size = 24 }: IconProps) => (
  <BadgeBase className={className} size={size}>
    ...
    <rect x="15" y="20" width="4" height="12" rx="1" fill="#0A8B46" />
    <rect x="22" y="20" width="4" height="12" rx="1" fill="#0A8B46" />
    <rect x="29" y="20" width="4" height="12" rx="1" fill="#0A8B46" />
  </BadgeBase>
);
...
export const LogisticsTrainModeIcon = ({ className, size = 24 }: IconProps) => (
  <BadgeBase className={className} size={size}>
    ...
    <rect x="17" y="16" width="6" height="5" rx="1" fill="#0A8B46" />
    <rect x="25" y="16" width="6" height="5" rx="1" fill="#0A8B46" />
    <rect x="17" y="24" width="14" height="3" rx="1.5" fill="#0A8B46" />
