...
const BadgeBase = ({ size = 24, className, children }: IconProps & { children: ReactNode }) => (
  ...
  >
    <circle cx="24" cy="24" r="22" fill="#073B9A" />
    <circle cx="24" cy="24" r="20" fill="#073B9A" fillOpacity="0.78" />
...
export const LogisticsExpressIcon = ({ className, size = 24 }: IconProps) => (
  <BadgeBase className={className} size={size}>
    ...
    <circle cx="15" cy="33" r="3" fill="#F51B2B" />
    <circle cx="30" cy="33" r="3" fill="#F51B2B" />
    <path d="M30 14L37 20L30 26" stroke="#F51B2B" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
  </BadgeBase>
);
...
export const LogisticsStandardIcon = ({ className, size = 24 }: IconProps) => (
  <BadgeBase className={className} size={size}>
    ...
    <rect x="12" y="13" width="14" height="6" rx="1.5" fill="#F51B2B" />
    <circle cx="16" cy="33" r="3" fill="#073B9A" />
    <circle cx="29" cy="33" r="3" fill="#073B9A" />
  </BadgeBase>
);
...
export const LogisticsInternationalIcon = ({ className, size = 24 }: IconProps) => (
  <BadgeBase className={className} size={size}>
    ...
    <path d="M36 11L40 14L36 17" stroke="#F51B2B" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M40 14H31" stroke="#F51B2B" strokeWidth="2.5" strokeLinecap="round" />
  </BadgeBase>
);
...
export const LogisticsTrackingIcon = ({ className, size = 24 }: IconProps) => (
  <BadgeBase className={className} size={size}>
    ...
    <rect x="16" y="15" width="10" height="2" rx="1" fill="#073B9A" />
    <rect x="16" y="20" width="14" height="2" rx="1" fill="#073B9A" />
    <circle cx="24" cy="30" r="5" fill="#073B9A" />
...
export const LogisticsRelayIcon = ({ className, size = 24 }: IconProps) => (
  <BadgeBase className={className} size={size}>
    ...
    <rect x="21" y="28" width="6" height="8" rx="1" fill="#073B9A" />
  </BadgeBase>
);
...
export const LogisticsAgencyIcon = ({ className, size = 24 }: IconProps) => (
  <BadgeBase className={className} size={size}>
    ...
    <rect x="12" y="10" width="24" height="5" rx="1.5" fill="#F51B2B" />
    <rect x="15" y="20" width="4" height="12" rx="1" fill="#073B9A" />
    <rect x="22" y="20" width="4" height="12" rx="1" fill="#073B9A" />
    <rect x="29" y="20" width="4" height="12" rx="1" fill="#073B9A" />
  </BadgeBase>
);
...
export const LogisticsCourierIcon = ({ className, size = 24 }: IconProps) => (
  <BadgeBase className={className} size={size}>
    ...
    <rect x="23" y="16" width="10" height="7" rx="1.5" fill="#F51B2B" />
  </BadgeBase>
);
...
export const LogisticsBikeModeIcon = ({ className, size = 24 }: IconProps) => (
  <BadgeBase className={className} size={size}>
    ...
    <path d="M23 18H28" stroke="#F51B2B" strokeWidth="2" strokeLinecap="round" />
  </BadgeBase>
);
...
export const LogisticsMotoModeIcon = ({ className, size = 24 }: IconProps) => (
  <BadgeBase className={className} size={size}>
    ...
    <rect x="24" y="16" width="8" height="5" rx="1.5" fill="#F51B2B" />
  </BadgeBase>
);
...
export const LogisticsCarModeIcon = ({ className, size = 24 }: IconProps) => (
  <BadgeBase className={className} size={size}>
    ...
    <circle cx="18" cy="33" r="3" fill="#F51B2B" />
    <circle cx="30" cy="33" r="3" fill="#F51B2B" />
  </BadgeBase>
);
...
export const LogisticsTrainModeIcon = ({ className, size = 24 }: IconProps) => (
  <BadgeBase className={className} size={size}>
    ...
    <rect x="17" y="16" width="6" height="5" rx="1" fill="#073B9A" />
    <rect x="25" y="16" width="6" height="5" rx="1" fill="#073B9A" />
    <rect x="17" y="24" width="14" height="3" rx="1.5" fill="#073B9A" />
    <path d="M18 35L15 39M30 35L33 39" stroke="#F51B2B" strokeWidth="2" strokeLinecap="round" />
  </BadgeBase>
);
