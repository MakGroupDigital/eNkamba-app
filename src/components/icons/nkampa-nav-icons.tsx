...
export const NkampaNavShopIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Détails du sac */}
    <rect x="12" y="20" width="24" height="3" rx="1.5" fill="#073B9A" opacity="0.6" />
    {/* Tag de prix */}
    <circle cx="24" cy="30" r="6" fill="#FFD700" />
    <text x="24" y="33" textAnchor="middle" fontSize="8" fill="#073B9A" fontWeight="bold">%</text>
    {/* Sparkles */}
    <circle cx="16" cy="12" r="2" fill="#073B9A" opacity="0.7" />
    <circle cx="32" cy="12" r="2" fill="#073B9A" opacity="0.7" />
...
export const NkampaNavOrdersIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <circle cx="16" cy="20" r="3" fill="#073B9A" />
    ...
    <circle cx="16" cy="28" r="3" fill="#073B9A" />
...
export const NkampaNavSellerIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Toit/Auvent */}
    <path d="M4 20L24 8L44 20" fill="#F51B2B" />
    <path d="M6 20H42V24H6Z" fill="#F51B2B" />
    {/* Rayures de l'auvent */}
    ...
    {/* Porte */}
    <rect x="20" y="32" width="8" height="12" rx="1" fill="#F51B2B" />
    <circle cx="26" cy="38" r="1" fill="#FFD700" />
    {/* Panneau "OPEN" */}
    <rect x="14" y="28" width="6" height="4" rx="0.5" fill="#073B9A" />
    <text x="17" y="31" textAnchor="middle" fontSize="2.5" fill="#fff" fontWeight="bold">OPEN</text>
    {/* Étoile de qualité */}
    <circle cx="38" cy="10" r="6" fill="#FFD700" />
    <path d="M38 7L39 10L42 10L40 12L41 15L38 13L35 15L36 12L34 10L37 10Z" fill="#F51B2B" />
  </svg>
);
