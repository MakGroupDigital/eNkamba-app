...
export const SuppliersIcon = ({ className, size = 48 }: IconProps) => (
  ...
  >
    ...
    <rect x="12" y="22" width="24" height="16" rx="1" fill="#009058" />
    {/* Fenêtres */}
    <rect x="14" y="24" width="4" height="4" fill="#009058" />
    <rect x="20" y="24" width="4" height="4" fill="#009058" />
    <rect x="26" y="24" width="4" height="4" fill="#009058" />
    <rect x="14" y="30" width="4" height="4" fill="#009058" />
    <rect x="20" y="30" width="4" height="4" fill="#009058" />
    <rect x="26" y="30" width="4" height="4" fill="#009058" />
    {/* Cheminées */}
...
export const WholesalersIcon = ({ className, size = 48 }: IconProps) => (
  ...
  >
    ...
    <rect x="10" y="32" width="28" height="6" rx="1" fill="#009058" />
    {/* Boîte 2 (milieu) */}
    <rect x="10" y="16" width="28" height="12" rx="1" fill="url(#wholesaleGrad)" />
    <rect x="14" y="19" width="20" height="5" rx="1" fill="#009058" />
    {/* Boîte 3 (haut) */}
...
export const RetailersIcon = ({ className, size = 48 }: IconProps) => (
  ...
  >
    ...
    <path d="M12 16H36V38C36 40 34 42 32 42H16C14 42 12 40 12 38V16Z" fill="#009058" opacity="0.3" />
    {/* Poignées */}
...
export const ProducersIcon = ({ className, size = 48 }: IconProps) => (
  ...
  >
    ...
    <ellipse cx="24" cy="32" rx="8" ry="3" fill="#009058" />
    {/* Tige */}
...
export const DigitalProductsIcon = ({ className, size = 48 }: IconProps) => (
  ...
  >
    ...
    <rect x="10" y="10" width="28" height="16" rx="1" fill="#009058" />
    {/* Contenu écran */}
    <rect x="12" y="12" width="8" height="4" fill="#009058" />
    <rect x="22" y="12" width="8" height="4" fill="#009058" />
    <rect x="12" y="18" width="18" height="2" fill="#009058" />
    <rect x="12" y="22" width="18" height="2" fill="#009058" />
    {/* Pied */}
...
export const TrackingIcon = ({ className, size = 48 }: IconProps) => (
  ...
  >
    ...
    <rect x="8" y="20" width="8" height="6" fill="#009058" />
    {/* Cargo */}
    <rect x="18" y="14" width="24" height="18" rx="1" fill="url(#trackingGrad)" />
    <rect x="20" y="16" width="20" height="14" rx="1" fill="#009058" />
    {/* Roues */}
    <circle cx="12" cy="34" r="3" fill="url(#trackingGrad)" />
    <circle cx="12" cy="34" r="1.5" fill="#009058" />
    <circle cx="38" cy="34" r="3" fill="url(#trackingGrad)" />
    <circle cx="38" cy="34" r="1.5" fill="#009058" />
    {/* Essieu */}
...
export const ProductIcon = ({ className, size = 48 }: IconProps) => (
  ...
  >
    ...
    <path d="M8 16L24 6L40 16" stroke="#009058" strokeWidth="1.5" fill="none" />
    {/* Rabat */}
    <path d="M8 16L24 24L40 16" stroke="#009058" strokeWidth="1.5" fill="none" />
    {/* Arête centrale */}
...
export const ServiceIcon = ({ className, size = 48 }: IconProps) => (
  ...
  >
    ...
    <circle cx="36" cy="24" r="3" fill="#009058" />
    {/* Dents de la clé */}
