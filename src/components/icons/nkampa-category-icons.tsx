...
export const AllCategoriesIcon = ({ className, size = 48 }: IconProps) => (
  ...
  >
    ...
    <rect x="10" y="18" width="28" height="20" rx="1" fill="#479B67" />
    {/* Porte */}
    <rect x="20" y="24" width="8" height="14" rx="1" fill="#479B67" />
    <circle cx="27" cy="31" r="1" fill="#479B67" />
    {/* Fenêtres */}
    <rect x="12" y="20" width="5" height="5" fill="#479B67" />
    <rect x="31" y="20" width="5" height={5} fill="#479B67" />
    {/* Toit */}
    <path d="M6 14L24 4L42 14" stroke="url(#allGrad)" strokeWidth="2" fill="none" />
    {/* Drapeau/Enseigne */}
    <rect x="38" y="8" width="2" height="8" fill="#479B67" />
...
export const SuppliersIcon = ({ className, size = 48 }: IconProps) => (
  ...
  >
    ...
    <rect x="12" y="22" width="24" height="16" rx="1" fill="#479B67" />
    {/* Fenêtres */}
    <rect x="14" y="24" width="4" height="4" fill="#479B67" />
    <rect x="20" y="24" width="4" height="4" fill="#479B67" />
    <rect x="26" y="24" width="4" height="4" fill="#479B67" />
    <rect x="14" y="30" width="4" height="4" fill="#479B67" />
    <rect x="20" y="30" width="4" height="4" fill="#479B67" />
    <rect x="26" y="30" width="4" height="4" fill="#479B67" />
    {/* Cheminées */}
    <rect x="10" y="6" width="3" height="12" fill="url(#supplierGrad)" />
    <rect x="35" y="8" width="3" height="10" fill="url(#supplierGrad)" />
    {/* Fumée */}
    <circle cx="11.5" cy="4" r="1.5" fill="#479B67" opacity="0.6" />
    <circle cx="36.5" cy="6" r="1.5" fill="#479B67" opacity="0.6" />
    {/* Porte */}
...
export const WholesalersIcon = ({ className, size = 48 }: IconProps) => (
  ...
  >
    ...
    <rect x="10" y="32" width="28" height="6" rx="1" fill="#479B67" />
    {/* Boîte 2 (milieu) */}
    <rect x="10" y="16" width="28" height="12" rx="1" fill="url(#wholesaleGrad)" />
    <rect x="14" y="19" width="20" height="5" rx="1" fill="#479B67" />
    {/* Boîte 3 (haut) */}
    <rect x="14" y="6" width="20" height="10" rx="1" fill="url(#wholesaleGrad)" />
    <rect x="17" y="8" width="14" height="4" rx="1" fill="#479B67" />
    {/* Ruban */}
...
export const RetailersIcon = ({ className, size = 48 }: IconProps) => (
  ...
  >
    ...
    <path d="M12 16H36V38C36 40 34 42 32 42H16C14 42 12 40 12 38V16Z" fill="#479B67" opacity="0.3" />
    {/* Poignées */}
...
export const ProducersIcon = ({ className, size = 48 }: IconProps) => (
  ...
  >
    ...
    <ellipse cx="24" cy="32" rx="8" ry="3" fill="#479B67" />
    {/* Tige */}
...
export const DigitalProductsIcon = ({ className, size = 48 }: IconProps) => (
  ...
  >
    ...
    <rect x="10" y="10" width="28" height="16" rx="1" fill="#479B67" />
    {/* Contenu écran */}
    <rect x="12" y="12" width="8" height="4" fill="#479B67" />
    <rect x="22" y="12" width="8" height="4" fill="#479B67" />
    <rect x="12" y="18" width="18" height="2" fill="#479B67" />
    <rect x="12" y="22" width="18" height="2" fill="#479B67" />
    {/* Pied */}
...
export const TrackingIcon = ({ className, size = 48 }: IconProps) => (
  ...
  >
    ...
    <rect x="8" y="20" width="8" height="6" fill="#479B67" />
    {/* Cargo */}
    <rect x="18" y="14" width="24" height="18" rx="1" fill="url(#trackingGrad)" />
    <rect x="20" y="16" width="20" height="14" rx="1" fill="#479B67" />
    {/* Roues */}
    <circle cx="12" cy="34" r="3" fill="url(#trackingGrad)" />
    <circle cx="12" cy="34" r="1.5" fill="#479B67" />
    <circle cx="38" cy="34" r="3" fill="url(#trackingGrad)" />
    <circle cx="38" cy="34" r="1.5" fill="#479B67" />
    {/* Essieu */}
...
export const ProductIcon = ({ className, size = 48 }: IconProps) => (
  ...
  >
    ...
    <path d="M8 16L24 6L40 16" stroke="#479B67" strokeWidth="1.5" fill="none" />
    {/* Rabat */}
    <path d="M8 16L24 24L40 16" stroke="#479B67" strokeWidth="1.5" fill="none" />
    {/* Arête centrale */}
    <line x1="24" y1="6" x2="24" y2="24" stroke="#479B67" strokeWidth="1" />
    {/* Décoration */}
...
export const ServiceIcon = ({ className, size = 48 }: IconProps) => (
  ...
  >
    ...
    <circle cx="36" cy="24" r="3" fill="#479B67" />
    {/* Dents de la clé */}
