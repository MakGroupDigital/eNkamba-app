...
export const ChatGroupCustomIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    <path d="M25 40C26 32 29 29 34 29C39 29 42 33 43 40H25Z" fill="#073B9A" opacity="0.9" />
  </svg>
);
...
export const ChatReadIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    <path d="M23 28L28 33L38 20" stroke="#F51B2B" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
...
export const ChatPhotoIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    <circle cx="30" cy="18" r="4" fill="#F51B2B" />
...
export const ChatMicCustomIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    <path d="M12 23C12 30 17 35 24 35C31 35 36 30 36 23" stroke="#F51B2B" strokeWidth="4" strokeLinecap="round" />
    <path d="M24 35V42" stroke="#073B9A" strokeWidth="4" strokeLinecap="round" />
    <path d="M18 42H30" stroke="#073B9A" strokeWidth="4" strokeLinecap="round" />
  </svg>
);
...
export const ChatLocationCustomIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    <circle cx="24" cy="18" r="3" fill="#F51B2B" />
  </svg>
);
...
export const ChatNotificationIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    <path d="M20 39C21 42 23 43 24 43C25 43 27 42 28 39H20Z" fill="#F51B2B" />
...
export const ChatCallIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    <path d="M33 12C37 14 39 17 40 22" stroke="#F51B2B" strokeWidth="3" strokeLinecap="round" />
  </svg>
);
...
export const ChatEditIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    <path d="M25 31L36 20L40 24L29 35L23 37L25 31Z" fill="#F51B2B" />
...
export const ChatEyeIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    <circle cx="24" cy="24" r="4" fill="#F51B2B" />
  </svg>
);
...
export const ChatEyeOffIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    <path d="M10 40L39 9" stroke="#F51B2B" strokeWidth="4" strokeLinecap="round" />
  </svg>
);
