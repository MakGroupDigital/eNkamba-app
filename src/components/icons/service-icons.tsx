...
export const SavingsIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Fente */}
    <rect x="18" y="17" width="12" height="3" rx="1.5" fill="#25543A" />
    {/* Pattes */}
    <rect x="12" y="36" width="4" height="6" rx="2" fill="#25543A" />
    <rect x="32" y="36" width="4" height="6" rx="2" fill="#25543A" />
    {/* Oreille */}
    <ellipse cx="36" cy="22" rx="4" ry="3" fill="#25543A" stroke="#25543A" strokeWidth="1" />
    {/* Œil */}
    <circle cx="32" cy="26" r="2" fill="#fff" />
    <circle cx="32.5" cy="26" r="1" fill="#25543A" />
    {/* Pièce qui tombe */}
...
export const CreditIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Billet arrière */}
    <rect x="8" y="14" width="28" height="18" rx="3" fill="#25543A" />
    {/* Billet avant */}
...
const tontinePositions = [
  { x: 40, y: 24, color: "#25543A" },    // 0°
  { x: 32, y: 37.86, color: "#FF8C00" }, // 60°
  { x: 16, y: 37.86, color: "#25543A" }, // 120°
  { x: 8, y: 24, color: "#FF8C00" },     // 180°
  { x: 16, y: 10.14, color: "#25543A" }, // 240°
...
export const TontineIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Lignes de connexion */}
    <circle cx="24" cy="24" r="16" stroke="#25543A" strokeWidth="1" strokeDasharray="4 2" fill="none" opacity="0.5" />
  </svg>
);
...
export const ConversionIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Flèches circulaires */}
    <path d="M26 12C30 8 38 10 40 16" stroke="#25543A" strokeWidth="2" strokeLinecap="round" />
    <path d="M40 16L42 12L38 13" stroke="#25543A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
...
export const ReferralIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Couvercle */}
    <rect x="6" y="14" width="36" height="8" rx="2" fill="#25543A" />
    {/* Ruban vertical */}
    <rect x="22" y="14" width="4" height="28" fill="#25543A" />
    {/* Ruban horizontal */}
    <rect x="6" y="16" width="36" height="4" fill="#25543A" />
    {/* Nœud */}
    <circle cx="24" cy="12" r="4" fill="#FF8C00" />
    <path d="M20 8C20 8 22 12 24 12C26 12 28 8 28 8" stroke="#E67E00" strokeWidth="2" fill="none" />
    {/* Étoiles */}
    <path d="M40 6L41 9L44 8L42 10L44 12L41 11L40 14L39 11L36 12L38 10L36 8L39 9L40 6Z" fill="#25543A" />
    <path d="M8 8L9 10L11 9L10 11L12 12L9 12L8 14L7 12L4 12L6 11L5 9L7 10L8 8Z" fill="#25543A" />
  </svg>
);
...
export const LinkAccountIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Icônes */}
    <circle cx="12" cy="24" r="3" fill="#25543A" />
    ...
    {/* Check */}
    <circle cx="24" cy="10" r="6" fill="#25543A" />
...
export const BonusIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Rubans */}
    <path d="M18 28L12 44L18 38L24 44L24 28" fill="#25543A" />
    <path d="M30 28L36 44L30 38L24 44L24 28" fill="#25543A" />
    {/* Médaille */}
...
export const TaxIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <path d="M30 6V12H36" fill="#25543A" />
    {/* Lignes de texte */}
...
export const YangoIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Toit */}
    <path d="M14 18L18 10H30L34 18H14Z" fill="#25543A" />
    {/* Vitres */}
    <path d="M16 18L19 12H23V18H16Z" fill="#25543A" opacity="0.5" />
    <path d="M25 18V12H29L32 18H25Z" fill="#25543A" opacity="0.5" />
    {/* Roues */}
...
export const TvIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Signal */}
    <path d="M38 4C40 6 41 8 41 11" stroke="#25543A" strokeWidth="2" strokeLinecap="round" fill="none" />
    <path d="M42 2C45 5 46 9 46 13" stroke="#25543A" strokeWidth="2" strokeLinecap="round" fill="none" />
  </svg>
);
...
export const AcademicIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Dessus du chapeau */}
    <path d="M24 8L4 18L24 16L44 18L24 8Z" fill="#25543A" />
    {/* Pompon */}
...
export const SchoolIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Bâtiment principal */}
    <rect x="8" y="20" width="32" height="24" fill="#25543A" />
    {/* Toit */}
    ...
    {/* Porte */}
    <rect x="20" y="30" width="8" height="14" rx="1" fill="#25543A" />
    <circle cx="26" cy="38" r="1" fill="#FF8C00" />
    {/* Cloche */}
    <path d="M24 10L22 14H26L24 10Z" fill="#FFE066" />
    <circle cx="24" cy="8" r="2" fill="#FFE066" />
    {/* Drapeau */}
    <line x1="38" y1="6" x2="38" y2="16" stroke="#25543A" strokeWidth="2" />
    <path d="M38 6H44L42 9L44 12H38V6Z" fill="#25543A" />
  </svg>
);
...
export const HotelIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Matelas */}
    <rect x="8" y="24" width="32" height="8" rx="2" fill="#25543A" />
    {/* Oreillers */}
    <ellipse cx="14" cy="24" rx="5" ry="3" fill="#fff" />
    <ellipse cx="26" cy="24" rx="5" ry="3" fill="#fff" />
    {/* Tête de lit */}
    <rect x="6" y="14" width="36" height="12" rx="2" fill="#25543A" />
    {/* Étoiles rating */}
    <g fill="#FF8C00">
...
export const HealthHospitalIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <rect x="16" y="34" width="6" height="10" rx="1" fill="#25543A" />
    <rect x="26" y="34" width="6" height="10" rx="1" fill="#25543A" />
...
export const HealthDoctorIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <path d="M16 14V24C16 30 20 34 24 34C28 34 32 30 32 24V14" stroke="#25543A" strokeWidth="3" strokeLinecap="round" />
    <circle cx="16" cy="14" r="3" fill="#25543A" />
    <circle cx="32" cy="14" r="3" fill="#25543A" />
...
export const HealthTeleconsultIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <path d="M13 31C14 26 16 24 20 24C24 24 26 26 27 31H13Z" fill="#25543A" />
    <path d="M32 19L42 14V32L32 27V19Z" fill="#FF8C00" />
    <rect x="18" y="38" width="12" height="4" rx="1" fill="#25543A" />
    <rect x="14" y="42" width="20" height="2" rx="1" fill="#25543A" />
  </svg>
);
...
export const FiveGoIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Lit */}
    <rect x="17" y="20" width="14" height="5" rx="1.5" fill="#25543A" />
    <rect x="17" y="16" width="6" height="4" rx="1.5" fill="#25543A" />
    <rect x="16" y="25" width="16" height="3" rx="1" fill="#25543A" />
    {/* Avion */}
...
export const FiveGoHotelIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <path d="M12 12H36V22H12V12Z" fill="#25543A" />
    ...
    <rect x="18" y="34" width="12" height="8" rx="1.5" fill="#25543A" />
    <g fill="#FF8C00">
...
export const MobilityIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Route */}
    <path d="M8 42C14 35 18 31 24 28C30 25 35 20 40 12" stroke="#25543A" strokeWidth="4" strokeLinecap="round" strokeDasharray="5 4" />
    {/* Voiture */}
    <path d="M8 30L12 21H36L40 30V36H8V30Z" fill="url(#mobilityGrad)" />
    <path d="M15 21L18 14H30L33 21H15Z" fill="#25543A" />
    <path d="M17 21L19 16H23V21H17Z" fill="#25543A" opacity="0.55" />
    <path d="M25 21V16H29L31 21H25Z" fill="#25543A" opacity="0.55" />
    ...
    {/* Pin destination */}
    <path d="M38 4C34 4 31 7 31 11C31 16 38 22 38 22C38 22 45 16 45 11C45 7 42 4 38 4Z" fill="#25543A" />
...
export const MotoRideIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <circle cx="25" cy="12" r="4" fill="#25543A" />
...
export const RideStarIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <circle cx="24" cy="24" r="7" fill="#25543A" opacity="0.9" />
...
export const EventIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Ticket droit */}
    <path d="M32 14H42V34H32V26C34 26 36 24 36 22C36 20 34 18 32 18V14Z" fill="#25543A" />
    {/* Perforation */}
    ...
    {/* Code barre */}
    <rect x="34" y="18" width="1" height="12" fill="#25543A" />
    <rect x="36" y="18" width="2" height="12" fill="#25543A" />
    <rect x="39" y="18" width="1" height="12" fill="#25543A" />
    {/* Confettis */}
    <circle cx="8" cy="10" r="2" fill="#25543A" />
    <circle cx="40" cy="8" r="2" fill="#FF8C00" />
    <rect x="14" y="6" width="3" height="3" rx="0.5" fill="#25543A" transform="rotate(15 14 6)" />
  </svg>
);
...
export const PhoneCreditIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Signal crédit */}
    <text x="24" y="24" textAnchor="middle" fontSize="10" fill="#25543A" fontWeight="bold">$</text>
    {/* Ondes signal */}
...
export const ESimIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Coin coupé */}
    <path d="M10 8L18 8L10 16Z" fill="#25543A" />
    {/* Puce */}
    ...
    {/* Signal waves */}
    <path d="M38 12C40 14 40 18 38 20" stroke="#25543A" strokeWidth="2" strokeLinecap="round" fill="none" />
    <path d="M42 8C45 11 45 21 42 24" stroke="#25543A" strokeWidth="2" strokeLinecap="round" fill="none" />
    {/* Texte eSIM */}
...
export const DonationIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Mains */}
    <path d="M8 28C8 28 4 24 4 20C4 16 8 14 12 18L14 20" stroke="#25543A" strokeWidth="3" strokeLinecap="round" fill="none" />
    <path d="M40 28C40 28 44 24 44 20C44 16 40 14 36 18L34 20" stroke="#25543A" strokeWidth="3" strokeLinecap="round" fill="none" />
    {/* Paumes */}
    <path d="M14 20L10 30C10 34 14 38 24 38C34 38 38 34 38 30L34 20" stroke="#25543A" strokeWidth="3" strokeLinecap="round" fill="none" />
    {/* Cœur central */}
...
export const NkampaIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Anse */}
    <path d="M14 14V10C14 6 18 2 24 2C30 2 34 6 34 10V14" stroke="#25543A" strokeWidth="3" strokeLinecap="round" fill="none" />
    {/* Produits dans le panier */}
    <rect x="12" y="20" width="8" height="10" rx="2" fill="#25543A" />
    <rect x="22" y="22" width="6" height="8" rx="1" fill="#25543A" />
    <circle cx="34" cy="26" r="4" fill="#25543A" />
    {/* Badge promo */}
    <circle cx="40" cy="8" r="6" fill="#25543A" />
...
export const UgaviIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <path d="M24 24V40L8 32V16L24 24Z" fill="#25543A" />
    <path d="M24 24V40L40 32V16L24 24Z" fill="#25543A" />
    {/* Colis */}
    ...
    {/* Globe indication */}
    <circle cx="8" cy="40" r="5" stroke="#25543A" strokeWidth="1.5" fill="none" />
    <ellipse cx="8" cy="40" rx="5" ry="2" stroke="#25543A" strokeWidth="1" fill="none" />
    <line x1="8" y1="35" x2="8" y2="45" stroke="#25543A" strokeWidth="1" />
  </svg>
);
...
export const MakutanoIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Personnes autour */}
    <circle cx="24" cy="6" r="4" fill="#25543A" />
    <circle cx="24" cy="2" r="2.5" fill="#25543A" />
    <circle cx="40" cy="16" r="4" fill="#FF8C00" />
    <circle cx="40" cy="12" r="2.5" fill="#FF8C00" />
    <circle cx="40" cy="32" r="4" fill="#25543A" />
    <circle cx="40" cy="28" r="2.5" fill="#25543A" />
    <circle cx="24" cy="42" r="4" fill="#FF8C00" />
    <circle cx="24" cy="38" r="2.5" fill="#FF8C00" />
    <circle cx="8" cy="32" r="4" fill="#25543A" />
    <circle cx="8" cy="28" r="2.5" fill="#25543A" />
...
export const MakutanoMusicIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={cn("", className)}>
    ...
    <circle cx="14" cy="34" r="7" fill="#25543A" />
    <circle cx="32" cy="28" r="7" fill="#25543A" />
    <path d="M8 14C11 11 14 10 18 10" stroke="#25543A" strokeWidth="2" strokeLinecap="round" opacity="0.7" />
  </svg>
);

export const MakutanoMoreIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={cn("", className)}>
    <circle cx="14" cy="24" r="5" fill="#25543A" />
    <circle cx="24" cy="24" r="5" fill="#25543A" />
    <circle cx="34" cy="24" r="5" fill="#FF8C00" />
    <path d="M14 34C20 38 28 38 34 34" stroke="#25543A" strokeWidth="2" strokeLinecap="round" opacity="0.55" />
  </svg>
);
...
export const MakutanoBookIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={cn("", className)}>
    ...
    <path d="M24 8V40" stroke="#25543A" strokeWidth="2.5" strokeLinecap="round" />
...
export const MakutanoIdeaIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={cn("", className)}>
    ...
    <path d="M18 39H30M20 44H28" stroke="#25543A" strokeWidth="2.5" strokeLinecap="round" />
    <path d="M18 22C18 18 20 16 24 16" stroke="#fff" strokeWidth="2.5" strokeLinecap="round" opacity="0.65" />
    <path d="M33 8L36 4M39 15L44 13M39 24H44" stroke="#25543A" strokeWidth="2.5" strokeLinecap="round" />
  </svg>
);
...
export const EnkambaAIIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <rect x="16" y="20" width="4" height="2" rx="1" fill="#25543A" />
    <rect x="28" y="20" width="4" height="2" rx="1" fill="#25543A" />
    {/* Bouche écran */}
    <rect x="16" y="28" width="16" height="6" rx="2" fill="#25543A" />
    <rect x="18" y="30" width="3" height="2" rx="0.5" fill="#25543A" />
    <rect x="22.5" y="30" width="3" height="2" rx="0.5" fill="#25543A" />
    <rect x="27" y="30" width="3" height="2" rx="0.5" fill="#25543A" />
    {/* Antenne */}
    <line x1="24" y1="4" x2="24" y2="10" stroke="#25543A" strokeWidth="2" />
...
export const SettingsPageIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Petit engrenage */}
    <circle cx="24" cy="24" r="6" fill="#25543A" />
...
export const SecurityIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Cadenas */}
    <rect x="16" y="22" width="16" height="14" rx="3" fill="#25543A" />
    <path d="M20 22V18C20 15.8 21.8 14 24 14C26.2 14 28 15.8 28 18V22" stroke="#25543A" strokeWidth="3" fill="none" />
    {/* Trou serrure */}
...
export const HelpIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <text x="24" y="28" textAnchor="middle" fontSize="12" fill="#25543A" fontWeight="bold">?</text>
  </svg>
);
...
export const NewChatIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Étoile */}
    <circle cx="40" cy="12" r="6" fill="#25543A" />
...
export const SearchIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Verre */}
    <circle cx="20" cy="20" r="8" fill="#25543A" fillOpacity="0.2" />
    {/* Manche */}
...
export const SendPackageIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <line x1="20" y1="16" x2="20" y2="36" stroke="#25543A" strokeWidth="2" />
    <line x1="8" y1="26" x2="32" y2="26" stroke="#25543A" strokeWidth="2" />
    {/* Ruban */}
...
export const TrackPackageIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Loupe */}
    <circle cx="36" cy="20" r="8" stroke="#25543A" strokeWidth="3" fill="none" />
    <line x1="42" y1="26" x2="46" y2="30" stroke="#25543A" strokeWidth="3" strokeLinecap="round" />
    {/* Check dans loupe */}
    <path d="M32 20L35 23L40 17" stroke="#25543A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none" />
    {/* Points de suivi */}
    <circle cx="10" cy="42" r="2" fill="#25543A" />
    <circle cx="20" cy="42" r="2" fill="#25543A" />
    <circle cx="30" cy="42" r="2" fill="#FF8C00" />
    <line x1="12" y1="42" x2="18" y2="42" stroke="#25543A" strokeWidth="1" strokeDasharray="2 1" />
    <line x1="22" y1="42" x2="28" y2="42" stroke="#25543A" strokeWidth="1" strokeDasharray="2 1" />
  </svg>
);
...
export const UgaviStopIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={cn("", className)}>
    ...
    <path d="M10 38H38" stroke="#25543A" strokeWidth="3" strokeLinecap="round" />
  </svg>
);
...
export const UgaviShareIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={cn("", className)}>
    ...
    <path d="M19 22L29 16M19 26L29 32" stroke="#25543A" strokeWidth="3" strokeLinecap="round" />
  </svg>
);
...
export const CalculatorIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Écran */}
    <rect x="12" y="8" width="24" height="10" rx="2" fill="#25543A" />
    <text x="32" y="15" textAnchor="end" fontSize="8" fill="#25543A" fontWeight="bold">123</text>
    {/* Boutons */}
    ...
    <rect x="30" y="38" width="6" height="4" rx="1" fill="#25543A" />
  </svg>
);
...
export const MapPinIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Point central */}
    <circle cx="24" cy="20" r="4" fill="#25543A" />
    {/* Ombre */}
...
export const ReceiveIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Sparkle */}
    <circle cx="8" cy="8" r="2" fill="#25543A" />
  </svg>
);
...
export const BulkPayIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Personne 1 */}
    <circle cx="12" cy="10" r="4" fill="#25543A" />
    <path d="M8 16C8 14 10 14 12 14C14 14 16 14 16 16V22H8V16Z" fill="#25543A" />
    {/* Personne 2 */}
    ...
    {/* Billets d'argent */}
    <rect x="10" y="28" width="12" height="8" rx="1" fill="#25543A" />
    ...
    <rect x="38" y="28" width="8" height="8" rx="1" fill="#25543A" />
    <text x="42" y="34" textAnchor="middle" fontSize="4" fill="#fff" fontWeight="bold">$</text>
    {/* Flèches de distribution */}
    <path d="M16 26L16 28" stroke="#25543A" strokeWidth="1.5" strokeLinecap="round" />
    <path d="M30 28L30 30" stroke="#FF8C00" strokeWidth="1.5" strokeLinecap="round" />
    <path d="M42 26L42 28" stroke="#25543A" strokeWidth="1.5" strokeLinecap="round" />
  </svg>
);
...
export const RequestIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Poignet */}
    <rect x="12" y="34" width="16" height="8" rx="2" fill="#25543A" />
    {/* Point d'interrogation */}
    <text x="24" y="38" textAnchor="middle" fontSize="8" fill="#fff" fontWeight="bold">?</text>
    {/* Bulle de demande */}
    <path d="M36 6C38 6 40 8 40 10V14C40 16 38 18 36 18L34 20L36 18H32C30 18 28 16 28 14V10C28 8 30 6 32 6H36Z" fill="#25543A" />
...
export const WorldShippingIconBrand = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <circle cx="18" cy="18" r="14" stroke="#25543A" strokeWidth="2" fill="none" />
    {/* Paquet/Boîte */}
    ...
    {/* Ruban */}
    <rect x="36" y="6" width="2" height="20" fill="#25543A" />
    <ellipse cx="37" cy="26" rx="3" ry="1.5" fill="#25543A" />
    {/* Flèche direction */}
    <path d="M24 30L28 34L26 32L30 36" stroke="#25543A" strokeWidth="2" fill="none" strokeLinecap="round" />
  </svg>
);
...
export const DeliveryMethodsIconBrand = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Cabine */}
    <rect x="30" y="14" width="10" height="10" rx="1" fill="#25543A" />
    {/* Vitres cabine */}
    ...
    {/* Pare-chocs/Tuyau */}
    <rect x="8" y="30" width="4" height="2" fill="#25543A" />
    {/* Lumière/Signal */}
    <circle cx="42" cy="20" r="2" fill="#FF8C00" opacity="0.8" />
    {/* Flèches vitesse */}
    <path d="M38 24L42 24M38 27L42 27" stroke="#25543A" strokeWidth="1.5" strokeLinecap="round" />
  </svg>
);
...
export const CalculateFeesIconBrand = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Écran */}
    <rect x="12" y="10" width="24" height="8" rx="1" fill="#25543A" />
    {/* Texte écran */}
    <text x="24" y="16" textAnchor="middle" fontSize="5" fill="#25543A" fontWeight="bold">28,750</text>
    {/* Grille de boutons */}
    <rect x="12" y="20" width="5" height="4" rx="1" fill="#25543A" stroke="#25543A" strokeWidth="1" />
    <rect x="19" y="20" width="5" height="4" rx="1" fill="#25543A" stroke="#25543A" strokeWidth="1" />
    <rect x="26" y="20" width="5" height="4" rx="1" fill="#25543A" stroke="#25543A" strokeWidth="1" />
    <rect x="33" y="20" width="3" height="4" rx="1" fill="#FF8C00" />
    {/* Deuxième rangée */}
    <rect x="12" y="26" width="5" height="4" rx="1" fill="#25543A" stroke="#25543A" strokeWidth="1" />
    <rect x="19" y="26" width="5" height="4" rx="1" fill="#25543A" stroke="#25543A" strokeWidth="1" />
    <rect x="26" y="26" width="5" height="4" rx="1" fill="#25543A" stroke="#25543A" strokeWidth="1" />
    <rect x="33" y="26" width="3" height="4" rx="1" fill="#FF8C00" />
    {/* Troisième rangée */}
    <rect x="12" y="32" width="5" height="4" rx="1" fill="#25543A" stroke="#25543A" strokeWidth="1" />
    <rect x="19" y="32" width="5" height="4" rx="1" fill="#25543A" stroke="#25543A" strokeWidth="1" />
    <rect x="26" y="32" width="5" height="4" rx="1" fill="#25543A" stroke="#25543A" strokeWidth="1" />
...
export const RelayPointIconBrand = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Toit */}
    <path d="M8 28L24 12L40 28" stroke="#25543A" strokeWidth="2" fill="none" />
    <path d="M10 28L24 16L38 28" fill="#E67E00" opacity="0.7" />
    {/* Porte */}
    <rect x="20" y="32" width="8" height="10" rx="1" fill="#25543A" />
    <circle cx="26" cy="37" r="1" fill="#FF8C00" />
    {/* Fenêtres */}
    <rect x="12" y="20" width="4" height="4" fill="#25543A" />
    <rect x="32" y="20" width="4" height="4" fill="#25543A" />
    <line x1="14" y1="20" x2="14" y2="24" stroke="#4FC3F7" strokeWidth="0.5" />
    <line x1="12" y1="22" x2="16" y2="22" stroke="#4FC3F7" strokeWidth="0.5" />
    {/* Drapeau/Indicateur */}
    <rect x="38" y="16" width="2" height="6" fill="#25543A" />
    <path d="M40 16C42 16 44 16 44 18C44 20 42 20 40 20Z" fill="#25543A" />
    {/* Marqueur localisation */}
    <circle cx="24" cy="10" r="3" fill="#25543A" stroke="#fff" strokeWidth="1" />
  </svg>
);
...
export const ElectronicsIconBrand = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Contenu écran */}
    <rect x="12" y="10" width="24" height="16" fill="#25543A" />
    {/* Cercles (boutons/interface) */}
    <circle cx="16" cy="14" r="3" fill="#25543A" opacity="0.8" />
    <circle cx="24" cy="14" r="3" fill="#FF8C00" opacity="0.8" />
    <circle cx="32" cy="14" r="3" fill="#25543A" opacity="0.8" />
    {/* Barres de contenu */}
    <rect x="14" y="20" width="6" height="2" rx="1" fill="#25543A" opacity="0.6" />
    <rect x="24" y="20" width="8" height="2" rx="1" fill="#FF8C00" opacity="0.6" />
    {/* Pied */}
    <rect x="18" y="30" width="12" height="4" fill="#25543A" />
    {/* Support */}
    <rect x="20" y="34" width="8" height="3" rx="1" fill="#25543A" />
    {/* Reflet brillant */}
...
export const FashionIconBrand = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Nœud/détail */}
    <circle cx="24" cy="10" r="3" fill="#25543A" />
    {/* Plis */}
    ...
    {/* Ceinture */}
    <ellipse cx="24" cy="19" rx="8" ry="1.5" fill="#25543A" />
  </svg>
);
...
export const HomeKitchenIconBrand = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Toit */}
    <path d="M6 24L24 8L42 24" stroke="#25543A" strokeWidth="2" fill="none" />
    {/* Porte */}
    <rect x="20" y="28" width="8" height="12" rx="1" fill="#25543A" />
    <circle cx="26" cy="34" r="1.5" fill="#FF8C00" />
    {/* Fenêtres */}
    <rect x="10" y="20" width="6" height="6" rx="1" fill="#25543A" />
    <rect x="32" y="20" width="6" height="6" rx="1" fill="#25543A" />
    {/* Fourchette */}
    ...
    {/* Couteau */}
    <path d="M36 12L36 22L34 20" stroke="#25543A" strokeWidth="2" strokeLinecap="round" />
    {/* Pot */}
    <ellipse cx="24" cy="12" rx="4" ry="3" fill="#25543A" opacity="0.7" />
...
export const BeautyIconBrand = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Bouchon */}
    <rect x="18" y="6" width="12" height="4" rx="1" fill="#25543A" />
    {/* Spray/Pompe */}
    <rect x="22" y="4" width="4" height="2" fill="#25543A" />
    {/* Étoiles/Sparkles */}
    <circle cx="32" cy="18" r="1.5" fill="#25543A" />
    <path d="M32 16L33 18L35 19L33 20L32 22L31 20L29 19L31 18L32 16Z" stroke="#25543A" strokeWidth="0.5" fill="#25543A" opacity="0.8" />
    {/* Paillettes */}
    <circle cx="20" cy="15" r="1" fill="#25543A" opacity="0.6" />
    <circle cx="26" cy="22" r="1" fill="#25543A" opacity="0.6" />
    {/* Reflet */}
...
export const SportsIconBrand = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Raquette */}
    <rect x="32" y="6" width="3" height="12" fill="#25543A" rx="1" />
    <circle cx="33.5" cy="4" r="3" fill="#25543A" />
    {/* Cordage */}
    ...
    <ellipse cx="10" cy="33" rx="2" ry="1.5" fill="#25543A" />
  </svg>
);
...
export const OthersIconBrand = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Couvercle */}
    <path d="M10 10L24 4L38 10V12L24 6L10 12V10Z" fill="#25543A" />
    {/* Ruban/Nœud */}
    <rect x="22" y="4" width="4" height="20" fill="#25543A" />
    <ellipse cx="24" cy="24" rx="4" ry="2" fill="#25543A" />
    {/* Ombres */}
    <path d="M8 28L14 36" stroke="#25543A" strokeWidth="1" opacity="0.5" />
    <path d="M40 28L34 36" stroke="#25543A" strokeWidth="1" opacity="0.5" />
    {/* Points de scellage */}
