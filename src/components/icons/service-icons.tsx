...
export const SavingsIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Fente */}
    <rect x="18" y="17" width="12" height="3" rx="1.5" fill="#073B9A" />
    {/* Pattes */}
    <rect x="12" y="36" width="4" height="6" rx="2" fill="#073B9A" />
    <rect x="32" y="36" width="4" height="6" rx="2" fill="#073B9A" />
    {/* Oreille */}
    <ellipse cx="36" cy="22" rx="4" ry="3" fill="#073B9A" stroke="#073B9A" strokeWidth="1" />
    {/* Œil */}
    <circle cx="32" cy="26" r="2" fill="#fff" />
    <circle cx="32.5" cy="26" r="1" fill="#073B9A" />
    {/* Pièce qui tombe */}
    <circle cx="24" cy="10" r="5" fill="#F51B2B" stroke="#F51B2B" strokeWidth="1" />
    <text x="24" y="12" textAnchor="middle" fontSize="6" fill="#fff" fontWeight="bold">$</text>
    {/* Sparkles */}
    <path d="M38 10L39 12L41 11L39 13L40 15L38 13L36 15L37 13L35 12L37 11L38 10Z" fill="#F51B2B" />
  </svg>
);
...
export const CreditIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Billet arrière */}
    <rect x="8" y="14" width="28" height="18" rx="3" fill="#073B9A" />
    {/* Billet avant */}
    ...
    <path d="M38 8L44 14L38 20" stroke="#F51B2B" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M44 14H32" stroke="#F51B2B" strokeWidth="3" strokeLinecap="round" />
  </svg>
);
...
const tontinePositions = [
  { x: 40, y: 24, color: "#073B9A" },    // 0°
  { x: 32, y: 37.86, color: "#F51B2B" }, // 60°
  { x: 16, y: 37.86, color: "#073B9A" }, // 120°
  { x: 8, y: 24, color: "#F51B2B" },     // 180°
  { x: 16, y: 10.14, color: "#073B9A" }, // 240°
  { x: 32, y: 10.14, color: "#F51B2B" }, // 300°
];
...
export const TontineIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Lignes de connexion */}
    <circle cx="24" cy="24" r="16" stroke="#073B9A" strokeWidth="1" strokeDasharray="4 2" fill="none" opacity="0.5" />
  </svg>
);
...
export const ConversionIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Pièce droite (EUR) */}
    <circle cx="32" cy="28" r="10" fill="#F51B2B" />
    <text x="32" y="32" textAnchor="middle" fontSize="10" fill="#fff" fontWeight="bold">€</text>
    {/* Flèches circulaires */}
    <path d="M26 12C30 8 38 10 40 16" stroke="#073B9A" strokeWidth="2" strokeLinecap="round" />
    <path d="M40 16L42 12L38 13" stroke="#073B9A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M22 36C18 40 10 38 8 32" stroke="#F51B2B" strokeWidth="2" strokeLinecap="round" />
    <path d="M8 32L6 36L10 35" stroke="#F51B2B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
  ...
  >
    <defs>
      <linearGradient id="giftGrad" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stopColor="#F51B2B" />
    ...
    {/* Couvercle */}
    <rect x="6" y="14" width="36" height="8" rx="2" fill="#073B9A" />
    {/* Ruban vertical */}
    <rect x="22" y="14" width="4" height="28" fill="#073B9A" />
    {/* Ruban horizontal */}
    <rect x="6" y="16" width="36" height="4" fill="#073B9A" />
    {/* Nœud */}
    <circle cx="24" cy="12" r="4" fill="#F51B2B" />
    <path d="M20 8C20 8 22 12 24 12C26 12 28 8 28 8" stroke="#F51B2B" strokeWidth="2" fill="none" />
    {/* Étoiles */}
    <path d="M40 6L41 9L44 8L42 10L44 12L41 11L40 14L39 11L36 12L38 10L36 8L39 9L40 6Z" fill="#073B9A" />
    <path d="M8 8L9 10L11 9L10 11L12 12L9 12L8 14L7 12L4 12L6 11L5 9L7 10L8 8Z" fill="#073B9A" />
  </svg>
);
...
export const AgentIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Étoile centrale */}
    <path d="M24 14L26.5 21H34L28 26L30 33L24 28L18 33L20 26L14 21H21.5L24 14Z" fill="#F51B2B" />
    {/* Cercle intérieur */}
...
export const LinkAccountIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Maillon droit */}
    <rect x="24" y="18" width="18" height="12" rx="6" stroke="#F51B2B" strokeWidth="4" fill="none" />
    {/* Icônes */}
    <circle cx="12" cy="24" r="3" fill="#073B9A" />
    <text x="12" y="26" textAnchor="middle" fontSize="4" fill="#fff" fontWeight="bold">📱</text>
    <circle cx="36" cy="24" r="3" fill="#F51B2B" />
    <text x="36" y="26" textAnchor="middle" fontSize="4" fill="#fff" fontWeight="bold">🏦</text>
    {/* Check */}
    <circle cx="24" cy="10" r="6" fill="#073B9A" />
...
export const BonusIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Rubans */}
    <path d="M18 28L12 44L18 38L24 44L24 28" fill="#073B9A" />
    <path d="M30 28L36 44L30 38L24 44L24 28" fill="#073B9A" />
    {/* Médaille */}
...
export const TaxIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <path d="M30 6V12H36" fill="#073B9A" />
    {/* Lignes de texte */}
    ...
    {/* Tampon */}
    <circle cx="28" cy="36" r="6" fill="#F51B2B" opacity="0.9" />
...
export const YangoIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Toit */}
    <path d="M14 18L18 10H30L34 18H14Z" fill="#073B9A" />
    {/* Vitres */}
    <path d="M16 18L19 12H23V18H16Z" fill="#073B9A" opacity="0.5" />
    <path d="M25 18V12H29L32 18H25Z" fill="#073B9A" opacity="0.5" />
    {/* Roues */}
...
export const TvIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Logo Canal+ stylisé */}
    <text x="24" y="24" textAnchor="middle" fontSize="10" fill="#F51B2B" fontWeight="bold">C+</text>
    {/* Pied */}
    <rect x="18" y="34" width="12" height="4" fill="#333" />
    <rect x="14" y="38" width="20" height="3" rx="1" fill="#333" />
    {/* Signal */}
    <path d="M38 4C40 6 41 8 41 11" stroke="#073B9A" strokeWidth="2" strokeLinecap="round" fill="none" />
    <path d="M42 2C45 5 46 9 46 13" stroke="#073B9A" strokeWidth="2" strokeLinecap="round" fill="none" />
  </svg>
);
...
export const AcademicIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Dessus du chapeau */}
    <path d="M24 8L4 18L24 16L44 18L24 8Z" fill="#073B9A" />
    {/* Pompon */}
    <line x1="40" y1="18" x2="40" y2="32" stroke="#F51B2B" strokeWidth="2" />
    <circle cx="40" cy="34" r="3" fill="#F51B2B" />
    {/* Base */}
    <path d="M12 22V32C12 36 18 40 24 40C30 40 36 36 36 32V22" stroke="url(#acadGrad)" strokeWidth="3" fill="none" />
    {/* Livre */}
    <rect x="18" y="42" width="12" height="4" rx="1" fill="#F51B2B" />
  </svg>
);
...
export const SchoolIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Bâtiment principal */}
    <rect x="8" y="20" width="32" height="24" fill="#073B9A" />
    {/* Toit */}
    ...
    {/* Porte */}
    <rect x="20" y="30" width="8" height="14" rx="1" fill="#073B9A" />
    <circle cx="26" cy="38" r="1" fill="#F51B2B" />
    {/* Cloche */}
    <path d="M24 10L22 14H26L24 10Z" fill="#FFE066" />
    <circle cx="24" cy="8" r="2" fill="#FFE066" />
    {/* Drapeau */}
    <line x1="38" y1="6" x2="38" y2="16" stroke="#073B9A" strokeWidth="2" />
    <path d="M38 6H44L42 9L44 12H38V6Z" fill="#073B9A" />
  </svg>
);
...
export const FlightIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Traînée */}
    <path d="M6 40C10 36 16 34 22 34" stroke="#F51B2B" strokeWidth="2" strokeLinecap="round" strokeDasharray="4 2" />
    {/* Nuages */}
...
export const HotelIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Matelas */}
    <rect x="8" y="24" width="32" height="8" rx="2" fill="#073B9A" />
    {/* Oreillers */}
    <ellipse cx="14" cy="24" rx="5" ry="3" fill="#fff" />
    <ellipse cx="26" cy="24" rx="5" ry="3" fill="#fff" />
    {/* Tête de lit */}
    <rect x="6" y="14" width="36" height="12" rx="2" fill="#073B9A" />
    {/* Étoiles rating */}
    <g fill="#F51B2B">
...
export const HealthIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Cœur */}
    <path d="M24 43C24 43 14 37 14 31C14 27 18 25 24 30C30 25 34 27 34 31C34 37 24 43 24 43Z" fill="#F51B2B" />
    {/* Signal vital */}
    <path d="M10 9H16L19 5L23 13L27 8H38" stroke="#F51B2B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
...
export const HealthEmergencyIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <path d="M30 22H38L42 28V34H30V22Z" fill="#F51B2B" />
    ...
    <path d="M8 13H16" stroke="#F51B2B" strokeWidth="2" strokeLinecap="round" />
    <path d="M10 9H18" stroke="#F51B2B" strokeWidth="2" strokeLinecap="round" />
  </svg>
);
...
export const HealthHospitalIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <path d="M18 8H30V16H18V8Z" fill="#F51B2B" />
    <rect x="22" y="18" width="4" height="12" rx="1" fill="#fff" />
    <rect x="18" y="22" width="12" height="4" rx="1" fill="#fff" />
    <rect x="16" y="34" width="6" height="10" rx="1" fill="#073B9A" />
    <rect x="26" y="34" width="6" height="10" rx="1" fill="#073B9A" />
...
export const HealthDoctorIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <circle cx="24" cy="12" r="6" fill="#F51B2B" />
    <path d="M12 42C13 31 17 24 24 24C31 24 35 31 36 42H12Z" fill="url(#healthDoctorGrad)" />
    <path d="M16 14V24C16 30 20 34 24 34C28 34 32 30 32 24V14" stroke="#073B9A" strokeWidth="3" strokeLinecap="round" />
    <circle cx="16" cy="14" r="3" fill="#073B9A" />
    <circle cx="32" cy="14" r="3" fill="#073B9A" />
    <path d="M24 34V39" stroke="#fff" strokeWidth="3" strokeLinecap="round" />
    <circle cx="24" cy="41" r="4" fill="#fff" />
    <circle cx="24" cy="41" r="2" fill="#F51B2B" />
  </svg>
);
...
export const HealthTeleconsultIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <circle cx="20" cy="20" r="4" fill="#F51B2B" />
    <path d="M13 31C14 26 16 24 20 24C24 24 26 26 27 31H13Z" fill="#073B9A" />
    <path d="M32 19L42 14V32L32 27V19Z" fill="#F51B2B" />
    <rect x="18" y="38" width="12" height="4" rx="1" fill="#073B9A" />
    <rect x="14" y="42" width="20" height="2" rx="1" fill="#073B9A" />
  </svg>
);
...
export const FiveGoIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Lit */}
    <rect x="17" y="20" width="14" height="5" rx="1.5" fill="#073B9A" />
    <rect x="17" y="16" width="6" height="4" rx="1.5" fill="#073B9A" />
    <rect x="16" y="25" width="16" height="3" rx="1" fill="#073B9A" />
    {/* Avion */}
    <path d="M35 10L29 16L25 15L24 16L28 19L25 22L22 21L21 22L25 25L28 29L29 28L28 25L31 22L34 26L35 25L34 21L40 15L35 10Z" fill="#F51B2B" />
  </svg>
);
...
export const FiveGoHotelIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <path d="M12 12H36V22H12V12Z" fill="#073B9A" />
    <rect x="11" y="27" width="26" height="7" rx="2" fill="#fff" opacity="0.95" />
    <rect x="13" y="24" width="8" height="5" rx="2" fill="#F51B2B" />
    <rect x="23" y="24" width="8" height="5" rx="2" fill="#F51B2B" />
    <rect x="18" y="34" width="12" height="8" rx="1.5" fill="#073B9A" />
    <g fill="#F51B2B">
...
export const FiveGoFlightIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <path d="M42 20H34V12C38 12 42 16 42 20Z" fill="#F51B2B" />
    <path d="M35 8L26 18L18 16L16 18L24 23L19 29L14 28L13 30L20 34L24 41L26 40L25 35L31 30L36 38L38 36L36 28L46 19L35 8Z" fill="#F51B2B" />
...
export const FiveGoBusIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <rect x="14" y="28" width="6" height="4" rx="1" fill="#F51B2B" />
    <rect x="22" y="28" width="6" height="4" rx="1" fill="#F51B2B" />
    <rect x="30" y="28" width="6" height="4" rx="1" fill="#F51B2B" />
    ...
    <path d="M6 6H26C30 6 33 9 33 13V13H8C7 13 6 12 6 11V6Z" fill="#F51B2B" />
...
export const MobilityIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Route */}
    <path d="M8 42C14 35 18 31 24 28C30 25 35 20 40 12" stroke="#073B9A" strokeWidth="4" strokeLinecap="round" strokeDasharray="5 4" />
    {/* Voiture */}
    <path d="M8 30L12 21H36L40 30V36H8V30Z" fill="url(#mobilityGrad)" />
    <path d="M15 21L18 14H30L33 21H15Z" fill="#073B9A" />
    <path d="M17 21L19 16H23V21H17Z" fill="#073B9A" opacity="0.55" />
    <path d="M25 21V16H29L31 21H25Z" fill="#073B9A" opacity="0.55" />
    ...
    {/* Pin destination */}
    <path d="M38 4C34 4 31 7 31 11C31 16 38 22 38 22C38 22 45 16 45 11C45 7 42 4 38 4Z" fill="#073B9A" />
...
export const EChurchIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <path d="M24 10V18" stroke="#F51B2B" strokeWidth="2.6" strokeLinecap="round" />
    <path d="M20.5 13.5H27.5" stroke="#F51B2B" strokeWidth="2.6" strokeLinecap="round" />
    <rect x="21" y="27" width="6" height="9" rx="2" fill="#073B9A" />
    <circle cx="34" cy="15" r="3" fill="#F51B2B" />
  </svg>
);
...
export const MotoRideIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <path d="M24 18L29 22L23 30H18L22 22L18 19" fill="#F51B2B" />
    <circle cx="25" cy="12" r="4" fill="#073B9A" />
    <path d="M4 24H14" stroke="#F51B2B" strokeWidth="2" strokeLinecap="round" strokeDasharray="3 3" />
  </svg>
);
...
export const RidePhoneIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <path d="M20 25C24 30 28 32 32 28L29 24C28 25 27 25 26 24L23 21C22 20 22 19 23 18L19 15C15 19 16 23 20 25Z" fill="#F51B2B" />
  </svg>
);
...
export const RideShieldIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <circle cx="36" cy="12" r="5" fill="#F51B2B" />
  </svg>
);
...
export const RideStarIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <circle cx="24" cy="24" r="7" fill="#073B9A" opacity="0.9" />
...
export const EventIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Ticket droit */}
    <path d="M32 14H42V34H32V26C34 26 36 24 36 22C36 20 34 18 32 18V14Z" fill="#073B9A" />
    {/* Perforation */}
    ...
    {/* Code barre */}
    <rect x="34" y="18" width="1" height="12" fill="#073B9A" />
    <rect x="36" y="18" width="2" height="12" fill="#073B9A" />
    <rect x="39" y="18" width="1" height="12" fill="#073B9A" />
    {/* Confettis */}
    <circle cx="8" cy="10" r="2" fill="#073B9A" />
    <circle cx="40" cy="8" r="2" fill="#F51B2B" />
    <rect x="14" y="6" width="3" height="3" rx="0.5" fill="#073B9A" transform="rotate(15 14 6)" />
  </svg>
);
...
export const PhoneCreditIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Signal crédit */}
    <text x="24" y="24" textAnchor="middle" fontSize="10" fill="#073B9A" fontWeight="bold">$</text>
    {/* Ondes signal */}
    <path d="M36 8C38 10 39 13 39 16" stroke="#F51B2B" strokeWidth="2" strokeLinecap="round" fill="none" />
    <path d="M40 5C43 8 45 13 45 18" stroke="#F51B2B" strokeWidth="2" strokeLinecap="round" fill="none" />
    {/* Plus */}
    <circle cx="38" cy="32" r="6" fill="#F51B2B" />
...
export const InsuranceIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Cœur */}
    <path d="M24 32C24 32 16 26 16 20C16 16 20 14 24 18C28 14 32 16 32 20C32 26 24 32 24 32Z" fill="#F51B2B" />
    {/* Check */}
    <path d="M20 24L23 27L28 20" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

// eSIM-Kenz - Carte SIM avec signal
export const ESimIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Coin coupé */}
    <path d="M10 8L18 8L10 16Z" fill="#073B9A" />
    {/* Puce */}
    ...
    {/* Signal waves */}
    <path d="M38 12C40 14 40 18 38 20" stroke="#073B9A" strokeWidth="2" strokeLinecap="round" fill="none" />
    <path d="M42 8C45 11 45 21 42 24" stroke="#073B9A" strokeWidth="2" strokeLinecap="round" fill="none" />
    {/* Texte eSIM */}
...
export const DonationIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Mains */}
    <path d="M8 28C8 28 4 24 4 20C4 16 8 14 12 18L14 20" stroke="#073B9A" strokeWidth="3" strokeLinecap="round" fill="none" />
    <path d="M40 28C40 28 44 24 44 20C44 16 40 14 36 18L34 20" stroke="#073B9A" strokeWidth="3" strokeLinecap="round" fill="none" />
    {/* Paumes */}
    <path d="M14 20L10 30C10 34 14 38 24 38C34 38 38 34 38 30L34 20" stroke="#073B9A" strokeWidth="3" strokeLinecap="round" fill="none" />
    {/* Cœur central */}
    <path d="M24 30C24 30 16 24 16 18C16 14 20 12 24 16C28 12 32 14 32 18C32 24 24 30 24 30Z" fill="url(#donateGrad)" />
    {/* Sparkles */}
    <circle cx="12" cy="10" r="2" fill="#F51B2B" />
    <circle cx="36" cy="10" r="2" fill="#F51B2B" />
...
export const ShopNavIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Badge */}
    <circle cx="38" cy="12" r="6" fill="#F51B2B" />
...
export const LogisticsNavIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Colis */}
    <rect x="8" y="18" width="8" height="8" rx="1" fill="#F51B2B" fillOpacity="0.8" />
    <rect x="18" y="20" width="6" height="6" rx="1" fill="#F51B2B" fillOpacity="0.6" />
  </svg>
);
...
export const AINavIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <circle cx="24" cy="5" r="3" fill="#F51B2B" />
    {/* Yeux */}
...
export const PaymentNavIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <ellipse cx="38" cy="22" rx="8" ry="4" fill="#F51B2B" />
    {/* Reflet pièce */}
...
export const MiyikiChatIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Bulle secondaire */}
    <path d="M42 14H44C45.1 14 46 14.9 46 16V26C46 27.1 45.1 28 44 28H42V32L38 28H34" stroke="#F51B2B" strokeWidth="2" fill="none" />
    {/* Étoile notification */}
    <circle cx="40" cy="10" r="6" fill="#F51B2B" />
...
export const NkampaIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Anse */}
    <path d="M14 14V10C14 6 18 2 24 2C30 2 34 6 34 10V14" stroke="#073B9A" strokeWidth="3" strokeLinecap="round" fill="none" />
    {/* Produits dans le panier */}
    <rect x="12" y="20" width="8" height="10" rx="2" fill="#073B9A" />
    <rect x="22" y="22" width="6" height="8" rx="1" fill="#073B9A" />
    <circle cx="34" cy="26" r="4" fill="#073B9A" />
    {/* Badge promo */}
    <circle cx="40" cy="8" r="6" fill="#073B9A" />
...
export const UgaviIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <path d="M24 24V40L8 32V16L24 24Z" fill="#073B9A" />
    <path d="M24 24V40L40 32V16L24 24Z" fill="#073B9A" />
    {/* Colis */}
    <rect x="18" y="26" width="12" height="8" rx="1" fill="#F51B2B" />
    <line x1="24" y1="26" x2="24" y2="34" stroke="#F51B2B" strokeWidth="1" />
    <line x1="18" y1="30" x2="30" y2="30" stroke="#F51B2B" strokeWidth="1" />
    {/* Flèche de direction */}
    <path d="M36 6L42 10L36 14" stroke="#F51B2B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none" />
    <path d="M42 10H32" stroke="#F51B2B" strokeWidth="2" strokeLinecap="round" />
    {/* Globe indication */}
    <circle cx="8" cy="40" r="5" stroke="#073B9A" strokeWidth="1.5" fill="none" />
    <ellipse cx="8" cy="40" rx="5" ry="2" stroke="#073B9A" strokeWidth="1" fill="none" />
    <line x1="8" y1="35" x2="8" y2="45" stroke="#073B9A" strokeWidth="1" />
  </svg>
);
...
export const MakutanoIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Personnes autour */}
    <circle cx="24" cy="6" r="4" fill="#073B9A" />
    <circle cx="24" cy="2" r="2.5" fill="#073B9A" />
    <circle cx="40" cy="16" r="4" fill="#F51B2B" />
    <circle cx="40" cy="12" r="2.5" fill="#F51B2B" />
    <circle cx="40" cy="32" r="4" fill="#073B9A" />
    <circle cx="40" cy="28" r="2.5" fill="#073B9A" />
    <circle cx="24" cy="42" r="4" fill="#F51B2B" />
    <circle cx="24" cy="38" r="2.5" fill="#F51B2B" />
    <circle cx="8" cy="32" r="4" fill="#073B9A" />
    <circle cx="8" cy="28" r="2.5" fill="#073B9A" />
    <circle cx="8" cy="16" r="4" fill="#F51B2B" />
    <circle cx="8" cy="12" r="2.5" fill="#F51B2B" />
    {/* Connexions */}
...
export const MakutanoCreateIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={cn("", className)}>
    ...
    <circle cx="35" cy="13" r="7" fill="#F51B2B" />
...
export const MakutanoMusicIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={cn("", className)}>
    ...
    <circle cx="14" cy="34" r="7" fill="#073B9A" />
    <circle cx="32" cy="28" r="7" fill="#073B9A" />
    <path d="M8 14C11 11 14 10 18 10" stroke="#073B9A" strokeWidth="2" strokeLinecap="round" opacity="0.7" />
  </svg>
);

export const MakutanoMoreIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={cn("", className)}>
    <circle cx="14" cy="24" r="5" fill="#073B9A" />
    <circle cx="24" cy="24" r="5" fill="#073B9A" />
    <circle cx="34" cy="24" r="5" fill="#F51B2B" />
    <path d="M14 34C20 38 28 38 34 34" stroke="#073B9A" strokeWidth="2" strokeLinecap="round" opacity="0.55" />
  </svg>
);
...
export const MakutanoLikeIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={cn("", className)}>
    ...
    <path d="M17 20V40H10C8 40 6 38 6 36V24C6 22 8 20 10 20H17Z" fill="#F51B2B" />
...
export const MakutanoCommentIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={cn("", className)}>
    ...
    <circle cx="38" cy="10" r="5" fill="#F51B2B" />
  </svg>
);
...
export const MakutanoShareIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={cn("", className)}>
    ...
    <circle cx="35" cy="13" r="5" fill="#F51B2B" />
  </svg>
);
...
export const MakutanoPauseIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={cn("", className)}>
    ...
    <circle cx="12" cy="36" r="5" fill="#F51B2B" />
  </svg>
);
...
export const MakutanoAudioIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={cn("", className)}>
    ...
    <path d="M34 18C37 21 37 27 34 30" stroke="#F51B2B" strokeWidth="4" strokeLinecap="round" />
    <path d="M39 13C45 19 45 29 39 35" stroke="#F51B2B" strokeWidth="3" strokeLinecap="round" opacity="0.7" />
  </svg>
);
...
export const MakutanoBookIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={cn("", className)}>
    ...
    <path d="M26 8H40C42 8 44 10 44 12V35C44 38 42 40 39 40H26V8Z" fill="#F51B2B" />
    <path d="M24 8V40" stroke="#073B9A" strokeWidth="2.5" strokeLinecap="round" />
...
export const MakutanoIdeaIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={cn("", className)}>
    ...
    <path d="M18 39H30M20 44H28" stroke="#073B9A" strokeWidth="2.5" strokeLinecap="round" />
    <path d="M18 22C18 18 20 16 24 16" stroke="#fff" strokeWidth="2.5" strokeLinecap="round" opacity="0.65" />
    <path d="M33 8L36 4M39 15L44 13M39 24H44" stroke="#073B9A" strokeWidth="2.5" strokeLinecap="round" />
  </svg>
);
...
export const EnkambaAIIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <rect x="16" y="20" width="4" height="2" rx="1" fill="#073B9A" />
    <rect x="28" y="20" width="4" height="2" rx="1" fill="#073B9A" />
    {/* Bouche écran */}
    <rect x="16" y="28" width="16" height="6" rx="2" fill="#073B9A" />
    <rect x="18" y="30" width="3" height="2" rx="0.5" fill="#073B9A" />
    <rect x="22.5" y="30" width="3" height="2" rx="0.5" fill="#073B9A" />
    <rect x="27" y="30" width="3" height="2" rx="0.5" fill="#073B9A" />
    {/* Antenne */}
    <line x1="24" y1="4" x2="24" y2="10" stroke="#073B9A" strokeWidth="2" />
    <circle cx="24" cy="4" r="3" fill="url(#brainGrad)" />
    {/* Ondes AI */}
    <path d="M6 20C4 22 4 26 6 28" stroke="#F51B2B" strokeWidth="2" strokeLinecap="round" fill="none" />
    <path d="M2 18C-1 22 -1 26 2 30" stroke="#F51B2B" strokeWidth="2" strokeLinecap="round" fill="none" opacity="0.5" />
    <path d="M42 20C44 22 44 26 42 28" stroke="#F51B2B" strokeWidth="2" strokeLinecap="round" fill="none" />
    <path d="M46 18C49 22 49 26 46 30" stroke="#F51B2B" strokeWidth="2" strokeLinecap="round" fill="none" opacity="0.5" />
    {/* Sparkles */}
...
export const SettingsPageIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Petit engrenage */}
    <circle cx="24" cy="24" r="6" fill="#073B9A" />
    <circle cx="24" cy="24" r="3" fill="#fff" fillOpacity="0.5" />
    {/* Sliders */}
    <rect x="20" y="22" width="8" height="2" rx="1" fill="#F51B2B" />
    <rect x="22" y="25" width="4" height="2" rx="1" fill="#F51B2B" />
  </svg>
);
...
export const UserProfileIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Badge vérifié */}
    <circle cx="36" cy="36" r="7" fill="#F51B2B" />
...
export const SecurityIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Cadenas */}
    <rect x="16" y="22" width="16" height="14" rx="3" fill="#073B9A" />
    <path d="M20 22V18C20 15.8 21.8 14 24 14C26.2 14 28 15.8 28 18V22" stroke="#073B9A" strokeWidth="3" fill="none" />
    {/* Trou serrure */}
    <circle cx="24" cy="28" r="2" fill="#F51B2B" />
    <rect x="23" y="28" width="2" height="4" rx="1" fill="#F51B2B" />
  </svg>
);
...
export const NotificationIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Battant */}
    <circle cx="24" cy="42" r="4" fill="#073B9A" />
    {/* Ondes */}
    <path d="M8 18C6 20 6 24 8 26" stroke="#F51B2B" strokeWidth="2" strokeLinecap="round" fill="none" />
    <path d="M40 18C42 20 42 24 40 26" stroke="#F51B2B" strokeWidth="2" strokeLinecap="round" fill="none" />
    {/* Badge notification */}
    <circle cx="36" cy="12" r="6" fill="#F51B2B" />
...
export const ThemeIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Couleurs */}
    <circle cx="14" cy="18" r="4" fill="#F51B2B" />
...
export const LanguageIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Texte A */}
    <circle cx="38" cy="38" r="8" fill="#F51B2B" />
...
export const HelpIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Bandes */}
    <path d="M10 14L18 22" stroke="#F51B2B" strokeWidth="6" strokeLinecap="round" />
    <path d="M30 22L38 14" stroke="#F51B2B" strokeWidth="6" strokeLinecap="round" />
    <path d="M30 26L38 34" stroke="#F51B2B" strokeWidth="6" strokeLinecap="round" />
    <path d="M10 34L18 26" stroke="#F51B2B" strokeWidth="6" strokeLinecap="round" />
    {/* Point d'interrogation */}
    <text x="24" y="28" textAnchor="middle" fontSize="12" fill="#073B9A" fontWeight="bold">?</text>
  </svg>
);
...
export const NewChatIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Étoile */}
    <circle cx="40" cy="12" r="6" fill="#073B9A" />
...
export const SearchIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Verre */}
    <circle cx="20" cy="20" r="8" fill="#073B9A" fillOpacity="0.2" />
    {/* Manche */}
...
export const SendPackageIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <line x1="20" y1="16" x2="20" y2="36" stroke="#073B9A" strokeWidth="2" />
    <line x1="8" y1="26" x2="32" y2="26" stroke="#073B9A" strokeWidth="2" />
    {/* Ruban */}
    <rect x="16" y="12" width="8" height="4" rx="1" fill="#F51B2B" />
    {/* Flèche envoi */}
    <path d="M36 24L44 16L44 22H40" stroke="#F51B2B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none" />
    <path d="M44 16L36 8" stroke="#F51B2B" strokeWidth="2" strokeLinecap="round" fill="none" />
  </svg>
);
...
export const TrackPackageIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <line x1="16" y1="20" x2="16" y2="36" stroke="#F51B2B" strokeWidth="1.5" />
    <line x1="6" y1="28" x2="26" y2="28" stroke="#F51B2B" strokeWidth="1.5" />
    {/* Loupe */}
    <circle cx="36" cy="20" r="8" stroke="#073B9A" strokeWidth="3" fill="none" />
    <line x1="42" y1="26" x2="46" y2="30" stroke="#073B9A" strokeWidth="3" strokeLinecap="round" />
    {/* Check dans loupe */}
    <path d="M32 20L35 23L40 17" stroke="#073B9A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none" />
    {/* Points de suivi */}
    <circle cx="10" cy="42" r="2" fill="#073B9A" />
    <circle cx="20" cy="42" r="2" fill="#073B9A" />
    <circle cx="30" cy="42" r="2" fill="#F51B2B" />
    <line x1="12" y1="42" x2="18" y2="42" stroke="#073B9A" strokeWidth="1" strokeDasharray="2 1" />
    <line x1="22" y1="42" x2="28" y2="42" stroke="#073B9A" strokeWidth="1" strokeDasharray="2 1" />
  </svg>
);
...
export const UgaviPlayIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={cn("", className)}>
    ...
    <path d="M9 39C15 35 21 34 28 35" stroke="#F51B2B" strokeWidth="3" strokeLinecap="round" strokeDasharray="4 3" />
  </svg>
);
...
export const UgaviStopIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={cn("", className)}>
    ...
    <path d="M10 38H38" stroke="#073B9A" strokeWidth="3" strokeLinecap="round" />
  </svg>
);
...
export const UgaviShareIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={cn("", className)}>
    ...
    <circle cx="14" cy="24" r="6" fill="#F51B2B" />
    <circle cx="34" cy="13" r="6" fill="url(#ugaviShareGrad)" />
    <circle cx="34" cy="35" r="6" fill="url(#ugaviShareGrad)" />
    <path d="M19 22L29 16M19 26L29 32" stroke="#073B9A" strokeWidth="3" strokeLinecap="round" />
  </svg>
);
...
export const CalculatorIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Écran */}
    <rect x="12" y="8" width="24" height="10" rx="2" fill="#073B9A" />
    <text x="32" y="15" textAnchor="end" fontSize="8" fill="#073B9A" fontWeight="bold">123</text>
    {/* Boutons */}
    ...
    <rect x="30" y="22" width="6" height="5" rx="1" fill="#F51B2B" />
    ...
    <rect x="30" y="30" width="6" height="5" rx="1" fill="#F51B2B" />
    <rect x="12" y="38" width="15" height="4" rx="1" fill="#fff" fillOpacity="0.8" />
    <rect x="30" y="38" width="6" height="4" rx="1" fill="#073B9A" />
  </svg>
);
...
export const MapPinIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Point central */}
    <circle cx="24" cy="20" r="4" fill="#073B9A" />
    {/* Ombre */}
...
export const SendIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Flèche d'envoi */}
    <path d="M28 32L38 22L36 24L28 32Z" fill="#F51B2B" />
    <path d="M28 32L38 22" stroke="#F51B2B" strokeWidth="2.5" strokeLinecap="round" />
    {/* Sparkle */}
    <circle cx="42" cy="8" r="2" fill="#F51B2B" />
  </svg>
);
...
export const ReceiveIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Sparkle */}
    <circle cx="8" cy="8" r="2" fill="#073B9A" />
  </svg>
);
...
export const BulkPayIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Personne 1 */}
    <circle cx="12" cy="10" r="4" fill="#073B9A" />
    <path d="M8 16C8 14 10 14 12 14C14 14 16 14 16 16V22H8V16Z" fill="#073B9A" />
    {/* Personne 2 */}
    ...
    {/* Personne 3 */}
    <circle cx="36" cy="10" r="4" fill="#F51B2B" />
    <path d="M32 16C32 14 34 14 36 14C38 14 40 14 40 16V22H32V16Z" fill="#F51B2B" />
    {/* Billets d'argent */}
    <rect x="10" y="28" width="12" height="8" rx="1" fill="#073B9A" />
    <text x="16" y="34" textAnchor="middle" fontSize="5" fill="#fff" fontWeight="bold">$</text>
    <rect x="24" y="30" width="12" height="8" rx="1" fill="#F51B2B" />
    <text x="30" y="36" textAnchor="middle" fontSize="5" fill="#fff" fontWeight="bold">$</text>
    <rect x="38" y="28" width="8" height="8" rx="1" fill="#073B9A" />
    <text x="42" y="34" textAnchor="middle" fontSize="4" fill="#fff" fontWeight="bold">$</text>
    {/* Flèches de distribution */}
    <path d="M16 26L16 28" stroke="#073B9A" strokeWidth="1.5" strokeLinecap="round" />
    <path d="M30 28L30 30" stroke="#F51B2B" strokeWidth="1.5" strokeLinecap="round" />
    <path d="M42 26L42 28" stroke="#073B9A" strokeWidth="1.5" strokeLinecap="round" />
  </svg>
);
...
export const RequestIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Poignet */}
    <rect x="12" y="34" width="16" height="8" rx="2" fill="#073B9A" />
    {/* Point d'interrogation */}
    <text x="24" y="38" textAnchor="middle" fontSize="8" fill="#fff" fontWeight="bold">?</text>
    {/* Bulle de demande */}
    <path d="M36 6C38 6 40 8 40 10V14C40 16 38 18 36 18L34 20L36 18H32C30 18 28 16 28 14V10C28 8 30 6 32 6H36Z" fill="#073B9A" />
...
export const WorldShippingIconBrand = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <circle cx="18" cy="18" r="14" stroke="#073B9A" strokeWidth="2" fill="none" />
    {/* Paquet/Boîte */}
    <path d="M32 10L40 14V26H32V10Z" fill="#F51B2B" />
    <path d="M40 14L44 18V30L40 26V14Z" fill="#F51B2B" />
    <path d="M32 10L36 6L44 10L40 14L32 10Z" fill="#FFB347" />
    {/* Ruban */}
    <rect x="36" y="6" width="2" height="20" fill="#073B9A" />
    <ellipse cx="37" cy="26" rx="3" ry="1.5" fill="#073B9A" />
    {/* Flèche direction */}
    <path d="M24 30L28 34L26 32L30 36" stroke="#073B9A" strokeWidth="2" fill="none" strokeLinecap="round" />
  </svg>
);
...
export const DeliveryMethodsIconBrand = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Cabine */}
    <rect x="30" y="14" width="10" height="10" rx="1" fill="#073B9A" />
    {/* Vitres cabine */}
    ...
    {/* Pare-chocs/Tuyau */}
    <rect x="8" y="30" width="4" height="2" fill="#073B9A" />
    {/* Lumière/Signal */}
    <circle cx="42" cy="20" r="2" fill="#F51B2B" opacity="0.8" />
    {/* Flèches vitesse */}
    <path d="M38 24L42 24M38 27L42 27" stroke="#073B9A" strokeWidth="1.5" strokeLinecap="round" />
  </svg>
);
...
export const CalculateFeesIconBrand = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Écran */}
    <rect x="12" y="10" width="24" height="8" rx="1" fill="#073B9A" />
    {/* Texte écran */}
    <text x="24" y="16" textAnchor="middle" fontSize="5" fill="#073B9A" fontWeight="bold">28,750</text>
    {/* Grille de boutons */}
    <rect x="12" y="20" width="5" height="4" rx="1" fill="#073B9A" stroke="#073B9A" strokeWidth="1" />
    <rect x="19" y="20" width="5" height="4" rx="1" fill="#073B9A" stroke="#073B9A" strokeWidth="1" />
    <rect x="26" y="20" width="5" height="4" rx="1" fill="#073B9A" stroke="#073B9A" strokeWidth="1" />
    <rect x="33" y="20" width="3" height="4" rx="1" fill="#F51B2B" />
    {/* Deuxième rangée */}
    <rect x="12" y="26" width="5" height="4" rx="1" fill="#073B9A" stroke="#073B9A" strokeWidth="1" />
    <rect x="19" y="26" width="5" height="4" rx="1" fill="#073B9A" stroke="#073B9A" strokeWidth="1" />
    <rect x="26" y="26" width="5" height="4" rx="1" fill="#073B9A" stroke="#073B9A" strokeWidth="1" />
    <rect x="33" y="26" width="3" height="4" rx="1" fill="#F51B2B" />
    {/* Troisième rangée */}
    <rect x="12" y="32" width="5" height="4" rx="1" fill="#073B9A" stroke="#073B9A" strokeWidth="1" />
    <rect x="19" y="32" width="5" height="4" rx="1" fill="#073B9A" stroke="#073B9A" strokeWidth="1" />
    <rect x="26" y="32" width="5" height="4" rx="1" fill="#073B9A" stroke="#073B9A" strokeWidth="1" />
    <rect x="33" y="32" width="3" height="8" rx="1" fill="#F51B2B" />
    {/* Boutons */}
...
export const RelayPointIconBrand = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Toit */}
    <path d="M8 28L24 12L40 28" stroke="#073B9A" strokeWidth="2" fill="none" />
    <path d="M10 28L24 16L38 28" fill="#F51B2B" opacity="0.7" />
    {/* Porte */}
    <rect x="20" y="32" width="8" height="10" rx="1" fill="#073B9A" />
    <circle cx="26" cy="37" r="1" fill="#F51B2B" />
    {/* Fenêtres */}
    <rect x="12" y="20" width="4" height="4" fill="#073B9A" />
    <rect x="32" y="20" width="4" height="4" fill="#073B9A" />
    <line x1="14" y1="20" x2="14" y2="24" stroke="#4FC3F7" strokeWidth="0.5" />
    <line x1="12" y1="22" x2="16" y2="22" stroke="#4FC3F7" strokeWidth="0.5" />
    {/* Drapeau/Indicateur */}
    <rect x="38" y="16" width="2" height="6" fill="#073B9A" />
    <path d="M40 16C42 16 44 16 44 18C44 20 42 20 40 20Z" fill="#073B9A" />
    {/* Marqueur localisation */}
    <circle cx="24" cy="10" r="3" fill="#073B9A" stroke="#fff" strokeWidth="1" />
  </svg>
);
...
export const ShippingHistoryIconBrand = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    <path d="M32 10L38 16L32 18" stroke="#F51B2B" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" />
    {/* Points de timeline */}
    <circle cx="36" cy="28" r="2" fill="#F51B2B" />
    <circle cx="38" cy="36" r="2" fill="#F51B2B" opacity="0.6" />
    <line x1="36" y1="30" x2="38" y2="34" stroke="#F51B2B" strokeWidth="1" opacity="0.6" />
  </svg>
);
...
export const ElectronicsIconBrand = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Contenu écran */}
    <rect x="12" y="10" width="24" height="16" fill="#073B9A" />
    {/* Cercles (boutons/interface) */}
    <circle cx="16" cy="14" r="3" fill="#073B9A" opacity="0.8" />
    <circle cx="24" cy="14" r="3" fill="#F51B2B" opacity="0.8" />
    <circle cx="32" cy="14" r="3" fill="#073B9A" opacity="0.8" />
    {/* Barres de contenu */}
    <rect x="14" y="20" width="6" height="2" rx="1" fill="#073B9A" opacity="0.6" />
    <rect x="24" y="20" width="8" height="2" rx="1" fill="#F51B2B" opacity="0.6" />
    {/* Pied */}
    <rect x="18" y="30" width="12" height="4" fill="#073B9A" />
    {/* Support */}
    <rect x="20" y="34" width="8" height="3" rx="1" fill="#073B9A" />
    {/* Reflet brillant */}
...
export const FashionIconBrand = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Nœud/détail */}
    <circle cx="24" cy="10" r="3" fill="#073B9A" />
    {/* Plis */}
    <path d="M22 15V25" stroke="#F51B2B" strokeWidth="1.5" opacity="0.7" />
    <path d="M26 15V25" stroke="#F51B2B" strokeWidth="1.5" opacity="0.7" />
    {/* Boutons */}
    <circle cx="24" cy="18" r="1.5" fill="#fff" opacity="0.8" />
    <circle cx="24" cy="23" r="1.5" fill="#fff" opacity="0.8" />
    {/* Ceinture */}
    <ellipse cx="24" cy="19" rx="8" ry="1.5" fill="#073B9A" />
  </svg>
);
...
export const HomeKitchenIconBrand = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Toit */}
    <path d="M6 24L24 8L42 24" stroke="#073B9A" strokeWidth="2" fill="none" />
    {/* Porte */}
    <rect x="20" y="28" width="8" height="12" rx="1" fill="#073B9A" />
    <circle cx="26" cy="34" r="1.5" fill="#F51B2B" />
    {/* Fenêtres */}
    <rect x="10" y="20" width="6" height="6" rx="1" fill="#073B9A" />
    <rect x="32" y="20" width="6" height="6" rx="1" fill="#073B9A" />
    {/* Fourchette */}
    <line x1="12" y1="14" x2="12" y2="22" stroke="#F51B2B" strokeWidth="1.5" strokeLinecap="round" />
    <circle cx="11" cy="14" r="1" fill="#F51B2B" />
    <circle cx="13" cy="14" r="1" fill="#F51B2B" />
    {/* Couteau */}
    <path d="M36 12L36 22L34 20" stroke="#073B9A" strokeWidth="2" strokeLinecap="round" />
    {/* Pot */}
    <ellipse cx="24" cy="12" rx="4" ry="3" fill="#073B9A" opacity="0.7" />
    <line x1="21" y1="12" x2="27" y2="12" stroke="#F51B2B" strokeWidth="1.5" strokeLinecap="round" />
  </svg>
);
...
export const BeautyIconBrand = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Contenu brillant */}
    <rect x="16" y="12" width="16" height="20" rx="1" fill="#F51B2B" opacity="0.6" />
    {/* Bouchon */}
    <rect x="18" y="6" width="12" height="4" rx="1" fill="#073B9A" />
    {/* Spray/Pompe */}
    <rect x="22" y="4" width="4" height="2" fill="#073B9A" />
    {/* Étoiles/Sparkles */}
    <circle cx="32" cy="18" r="1.5" fill="#073B9A" />
    <path d="M32 16L33 18L35 19L33 20L32 22L31 20L29 19L31 18L32 16Z" stroke="#073B9A" strokeWidth="0.5" fill="#073B9A" opacity="0.8" />
    {/* Paillettes */}
    <circle cx="20" cy="15" r="1" fill="#073B9A" opacity="0.6" />
    <circle cx="26" cy="22" r="1" fill="#073B9A" opacity="0.6" />
    {/* Reflet */}
...
export const SportsIconBrand = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Raquette */}
    <rect x="32" y="6" width="3" height="12" fill="#073B9A" rx="1" />
    <circle cx="33.5" cy="4" r="3" fill="#073B9A" />
    {/* Cordage */}
    <path d="M31 4.5H36M31 6H36M31 7.5H36" stroke="#F51B2B" strokeWidth="0.5" opacity="0.8" />
    {/* Chaussure */}
    <path d="M8 30C6 28 6 34 8 36C12 38 18 36 20 32" fill="#F51B2B" opacity="0.7" />
    <ellipse cx="10" cy="33" rx="2" ry="1.5" fill="#073B9A" />
  </svg>
);
...
export const OthersIconBrand = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Couvercle */}
    <path d="M10 10L24 4L38 10V12L24 6L10 12V10Z" fill="#073B9A" />
    {/* Ruban/Nœud */}
    <rect x="22" y="4" width="4" height="20" fill="#073B9A" />
    <ellipse cx="24" cy="24" rx="4" ry="2" fill="#073B9A" />
    {/* Ombres */}
    <path d="M8 28L14 36" stroke="#073B9A" strokeWidth="1" opacity="0.5" />
    <path d="M40 28L34 36" stroke="#073B9A" strokeWidth="1" opacity="0.5" />
    {/* Points de scellage */}
