...
export const SuppliersIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Toit */}
    <polygon points="8,18 24,6 40,18" fill="#0A8B46" />
    {/* Fenêtres */}
    ...
    {/* Cheminée */}
    <rect x="20" y="8" width="4" height="8" fill="#0A8B46" />
...
export const WholesalersIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Boîte 2 (milieu) */}
    <rect x="10" y="18" width="28" height="10" rx="1" fill="#0A8B46" opacity="0.8" />
    <line x1="10" y1="23" x2="38" y2="23" stroke="#fff" strokeWidth="1" opacity="0.3" />
    {/* Boîte 3 (haut) */}
    <rect x="12" y="10" width="24" height="8" rx="1" fill="#0A8B46" opacity="0.6" />
...
export const RetailBuyIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Panier */}
    <path d="M10 16L12 8H36L38 16M12 16H36L34 32H14L12 16Z" fill="url(#retailGrad)" stroke="#0A8B46" strokeWidth="1.5" />
    {/* Poignées */}
    <path d="M16 8C16 4 20 2 24 2C28 2 32 4 32 8" stroke="#0A8B46" strokeWidth="2" strokeLinecap="round" />
    {/* Roues */}
    <circle cx="18" cy="36" r="2" fill="#0A8B46" />
    <circle cx="30" cy="36" r="2" fill="#0A8B46" />
  </svg>
);
...
export const TrackingIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Benne */}
    <rect x="18" y="14" width="24" height="18" rx="1" fill="#0A8B46" opacity="0.8" />
    {/* Roues */}
    <circle cx="12" cy="34" r="3" fill="#0A8B46" />
    <circle cx="38" cy="34" r="3" fill="#0A8B46" />
    {/* Fenêtre */}
...
export const B2BProductIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Toit */}
    <polygon points="10,14 24,4 38,14" fill="#0A8B46" />
    {/* Fenêtres */}
    ...
    {/* Porte */}
    <rect x="21" y="32" width="6" height="8" fill="#0A8B46" />
  </svg>
);
...
export const B2CProductIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Sac */}
    <path d="M12 14L14 8H34L36 14L34 36H14L12 14Z" fill="url(#b2cGrad)" stroke="#0A8B46" strokeWidth="1.5" />
    {/* Poignées */}
    <path d="M18 8C18 4 20 2 24 2C28 2 30 4 30 8" stroke="#0A8B46" strokeWidth="2" strokeLinecap="round" />
    {/* Motif */}
...
export const ContactIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Téléphone */}
    <rect x="12" y="6" width="24" height="36" rx="3" fill="url(#contactGrad)" stroke="#0A8B46" strokeWidth="1.5" />
    {/* Écran */}
...
export const MOQIcon = ({ className, size = 24 }: IconProps) => (
  ...
  >
    ...
    {/* Couvercle */}
    <path d="M10 14L14 8H34L38 14" fill="#0A8B46" />
  </svg>
);
