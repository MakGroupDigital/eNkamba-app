    ...
    <section className="rounded-[8px] border border-primary/10 bg-white p-4 shadow-sm">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Button
            size="sm"
            className="h-9 gap-2 bg-[#0A8B46] hover:bg-[#0A8B46]"
        ...
        <div className="flex flex-wrap gap-2">
          {[
            ...
            <Button
              ...
              className={cn('h-9', severityFilter === item.key && 'bg-[#0A8B46] hover:bg-[#0A8B46]')}
    ...
    <div className="space-y-4">
      <section className="rounded-[8px] border border-primary/10 bg-white p-4 shadow-sm">
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div>
            <h2 className="flex items-center gap-2 font-headline text-xl font-bold"><Fingerprint className="h-5 w-5 text-[#0A8B46]" />Cyber intelligence</h2>
        ...
        <div className="mt-4 grid gap-3 md:grid-cols-4">
          {[
            ...
            return (
              <div key={item.label} className="rounded-[8px] border border-slate-200 bg-slate-50 p-3">
                <Icon className="h-4 w-4 text-[#0A8B46]" />
          ...
          <div className="flex flex-wrap gap-2">
            {[
              ...
              <Button
                ...
                className={cn('h-9', activityFilter === item.key && 'bg-[#0A8B46] hover:bg-[#0A8B46]')}
        ...
        {filteredActivities.length === 0 ? (
          ...
          <div key={activity.id} className="rounded-[8px] border border-slate-200 bg-white p-3">
            <div className="flex items-start justify-between gap-3">
              ...
              <Badge variant={activity.active ? 'default' : 'secondary'} className={activity.active ? 'bg-[#0A8B46] hover:bg-[#0A8B46]' : ''}>{activity.active ? 'Actif' : formatDuration(activity.durationSeconds)}</Badge>
            </div>
    ...
    <div className="space-y-4">
      ...
      <section className="rounded-[8px] border border-primary/10 bg-white p-4 shadow-sm">
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          ...
          <Badge className="w-fit bg-[#0A8B46] hover:bg-[#0A8B46]">Export local</Badge>
        </div>
          ...
          {exportActions.map((item) => {
            ...
            return (
              <button
                ...
                type="button"
                onClick={item.action}
                className="rounded-[8px] border border-slate-200 bg-slate-50 p-4 text-left transition hover:border-[#0A8B46]/50 hover:bg-[#0A8B46]/5"
              >
                <Icon className="h-5 w-5 text-[#0A8B46]" />
                <p className="mt-3 font-bold">{item.label}</p>
                <p className="mt-1 text-xs leading-5 text-slate-500">{item.detail}</p>
                <span className="mt-3 inline-flex items-center gap-1 text-sm font-semibold text-[#0A8B46]">
