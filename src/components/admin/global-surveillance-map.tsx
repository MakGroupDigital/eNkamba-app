      ...
      <div className="grid gap-0 xl:grid-cols-[1.12fr_0.88fr]">
        <div className="relative min-h-[420px] overflow-hidden border-b border-white/10 bg-[radial-gradient(circle_at_50%_40%,rgba(50,187,120,0.18),rgba(2,6,23,0.25)_48%,rgba(2,6,23,0.96))] xl:border-b-0 xl:border-r">
          ...
          <div className="absolute left-4 top-4 z-20 flex flex-wrap items-center gap-2">
            <Badge className="bg-[#0A8B46] hover:bg-[#0A8B46]">
          ...
          <svg className="absolute inset-0 h-full w-full p-5" viewBox="0 0 1000 520" role="img" aria-label="Carte mondiale de surveillance eNkamba">
            <path className="fill-[#0A8B46]/25 stroke-[#0A8B46]/80 stroke-2" d="M166 138c36-34 98-42 140-18 31 17 46 48 73 66 28 18 63 20 81 46 20 29 3 72-33 82-26 7-54-7-79 4-31 14-37 59-68 76-26 14-60 3-78-20-19-25-16-58-32-85-17-29-55-43-63-76-7-27 17-54 59-75z" />
            <path className="fill-[#0A8B46]/25 stroke-[#0A8B46]/80 stroke-2" d="M320 326c34 6 66 25 82 55 17 33 10 73-8 106-12 22-32 44-58 42-32-3-40-38-51-64-12-31-43-47-53-78-12-37 26-68 88-61z" />
            <path className="fill-[#0A8B46]/25 stroke-[#0A8B46]/80 stroke-2" d="M474 120c42-20 95-19 135 2 26 14 44 37 73 45 31 9 66-1 96 13 38 17 55 63 45 103-10 39-43 65-80 74-35 9-72 2-105 17-33 16-52 53-87 65-34 12-73-4-91-35-18-30-15-69 1-100 18-35 51-59 65-96 12-31-6-58-52-88z" />
            <path className="fill-[#0A8B46]/25 stroke-[#0A8B46]/80 stroke-2" d="M535 288c50 4 102 28 127 72 26 45 19 105-9 148-20 31-54 54-91 45-36-9-49-48-62-80-15-38-50-64-55-105-5-45 36-83 90-80z" />
            <path className="fill-[#0A8B46]/25 stroke-[#0A8B46]/80 stroke-2" d="M656 118c56-30 139-24 188 17 45 38 58 103 37 158-18 47-60 76-108 86-49 10-99 1-148 11-34 7-67 22-101 14 19-33 54-52 67-91 13-40-5-83 9-123 9-28 28-52 56-72z" />
            <path className="fill-[#0A8B46]/25 stroke-[#0A8B46]/80 stroke-2" d="M780 367c38-16 92-7 121 24 25 27 27 70 4 98-24 30-72 34-107 18-31-15-58-47-50-83 5-25 15-44 32-57z" />
          ...
          {surveillancePoints.map((point) => (
            ...
            >
              <span className={cn('absolute inset-0 rounded-full bg-[#0A8B46]/40 animate-ping', selectedPoint.city === point.city && 'bg-[#FFA500]/45')} />
              <span className={cn('absolute left-1/2 top-1/2 h-3 w-3 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#0A8B46] shadow-[0_0_18px_rgba(126,231,175,0.95)]', selectedPoint.city === point.city && 'bg-[#FFA500] shadow-[0_0_22px_rgba(255,165,0,0.95)]')} />
            </button>
          ))}
          ...
          <div className="absolute bottom-4 left-4 right-4 z-20 grid gap-3 rounded-[8px] border border-white/10 bg-slate-950/80 p-4 backdrop-blur md:grid-cols-4">
            <div className="md:col-span-2">
              <p className="text-xs font-semibold uppercase tracking-[0.16em] text-[#0A8B46]">Point selectionne</p>
        ...
        <aside className="p-4">
          <div className="grid gap-3 sm:grid-cols-3">
            <div className="rounded-[8px] border border-white/10 bg-white/[0.06] p-3">
              <Server className="h-5 w-5 text-[#0A8B46]" />
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    selectedNode.id === node.id ? 'border-[#0A8B46] bg-[#0A8B46]/12' : 'border-white/10 bg-white/[0.06]',
                  )}
                >
          ...
          <div className="mt-4 rounded-[8px] border border-[#0A8B46]/25 bg-[#0A8B46]/10 p-4">
            <div className="flex items-start gap-3">
              <RadioTower className="mt-1 h-5 w-5 text-[#0A8B46]" />
              <div>
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  <Badge className="bg-[#0A8B46] hover:bg-[#0A8B46]">{selectedNode.module}</Badge>
