  ...
  const submitBusinessRequest = async (formData: BusinessFormState) => {
    ...
    try {
      ...
      const newRequest = {
        ...
        moduleServices: formData.moduleServices,
        serviceNote: formData.serviceNote || null,
        commerceFocus: formData.commerceFocus || null,
        logisticsOperationMode: formData.logisticsOperationMode || null,
